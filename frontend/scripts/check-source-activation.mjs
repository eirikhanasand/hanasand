...
const source = { id: 'source-one', tenantId: 'default', name: 'Example feed', status: 'candidate', family: 'vendor', owner: 'source-ops', accessMethod: 'public_http', risk: 'low', lastRunAt: '', lastContentAt: '', healthState: 'not observed', cadenceMinutes: 60, productiveCycleCount: 0, retainedEvidenceCount: 0, customerMatchCount: 0, domains: [], url: 'https://example.com' }
...
try {
    ...
    console.log('Source activation browser passed: inactive label, activate/deactivate, failed update retry, saved state after reload, and Run visibility.')
