...
assert(pageClientSource.includes('selectedCaseCreateRequestFor(result, selected, actionability'), 'Selected case create request should consume selected evidence and backed actionability state.')
