...
assert(pageClientSource.includes('data-ti-top-selected-evidence'), 'Public TI page should promote selected evidence before secondary workspace panels.')
assert(pageClientSource.includes('TopSelectedEvidencePanel'), 'Public TI hero should render a compact selected-evidence workflow panel.')
assert(pageClientSource.includes('data-ti-top-evidence-queue'), 'Public TI desktop hero should expose a compact evidence queue beside selected detail.')
assert(pageClientSource.includes('TopEvidenceQueuePreview'), 'Public TI desktop hero should connect queue row selection to the selected evidence detail.')
