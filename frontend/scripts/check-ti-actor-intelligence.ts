...
assert(pageClientSource.includes('stagedHandoffFor'), 'Staged handoffs should combine review, source drilldown, case draft, and case create request payloads.')
...
assert(pageClientSource.includes('disabled={!reviewHandoff || !caseDraft || !caseCreateRequest}'), 'Stage handoff should require the full case create request.')
