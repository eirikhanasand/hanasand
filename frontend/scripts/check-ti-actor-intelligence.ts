...
assert(pageClientSource.includes('data-ti-sources=\'true\''), 'Public TI page should expose sources.')
...
assert(pageClientSource.indexOf('data-ti-activity=\'true\'') < pageClientSource.indexOf('data-ti-sources=\'true\''), 'Public TI should place sources after recent activity.')
...
assert(pageClientSource.includes('title=\'Summary\''), 'Public TI analyst brief should use a full-width Summary section.')
assert(!pageClientSource.includes('title=\'What happened\''), 'Public TI analyst brief should not use the old What happened label.')
assert(!pageClientSource.includes('title=\'Why it matters\''), 'Public TI analyst brief should not render the removed why-it-matters column.')
assert(!pageClientSource.includes('title=\'Next action\''), 'Public TI analyst brief should not render the removed next-action column.')
...
assert(pageClientSource.includes('captureReferenceLabel(row.captureId)'), 'Public TI source/provenance rows should avoid rendering raw capture IDs.')
...
assert(pageClientSource.includes('title=\'Summary\''), 'Selected evidence should translate the row into concise analyst summary language.')
