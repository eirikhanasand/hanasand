...
assert(pageClientSource.includes('Handoff status'), 'Public TI page should expose consumer-ready workflow state.')
...
assert(pageClientSource.includes('Workflow state'), 'Public TI page should expose backed readiness and degraded states.')
