...
assert.equal((healthyMarkup.match(/<details/g) || []).length, 3, 'Queries collapse individually; longest query stays flat')
assert.match(healthyMarkup, /<details class="min-w-0 space-y-3" data-query-card="true"><summary/)
