...
const tasks: TestTask[] = [
    ...
    { id: 'support-ui', title: 'AI support, human handoff and internal queue layout', command: [bun, 'x', 'playwright', 'test', 'tests/support-ai.spec.ts', 'tests/support-layout.spec.ts', 'tests/support-floating.spec.ts', 'tests/support-realtime.spec.ts', '--workers=2'], requires: 'playwright' },
