...
assert.ok(dashboardPageSource.includes('alertWorkflowActions(alert, deliveryState, scope)'), 'Dashboard live alert cases should expose backed alert workflow actions.')
