...
const client = await readFile('src/utils/pwned/checkPassword.ts', 'utf8')
...
assert.match(route, /Unable to check the password exposure dataset right now\./, 'Same-origin route should preserve an actionable unavailable state')
