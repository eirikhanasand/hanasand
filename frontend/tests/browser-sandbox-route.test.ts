...
test('regular browser sandbox route and broker contract are wired', () => {
    ...
    assert(clientSource.includes('10 active sandboxes by default'), 'client should disclose the default regular sandbox capacity.')
    ...
    assert(brokerSource.includes('DEFAULT_REGULAR_SANDBOX_MAX_SESSIONS = 10'), 'broker should default regular browser sandbox capacity to ten active sessions.')
