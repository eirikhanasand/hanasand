...
test('certificate states are explicit and neutral details open by click and keyboard', async ({ context, page, baseURL }) => {
    ...
    const search = page.getByRole('searchbox', { name: 'Find a case or monitor' })
    const searchToggle = page.getByRole('button', { name: 'Find a case or monitor (Cmd J)', exact: true })
