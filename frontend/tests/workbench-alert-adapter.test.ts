...
test('maps persisted org DWM alerts into backed analyst workbench rows', () => {
    ...
    assert.equal(row.caseDetailHref, '/cases/case_acme_lumma?organizationId=org_acme&tenantId=tenant_acme&alertId=dwm_alert_org_acme_lumma&route=ti_workbench')
