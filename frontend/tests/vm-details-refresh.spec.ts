...
test('refresh updates every card and timestamp; failed refresh retains the snapshot and offers retry', async ({ page }) => {
    ...
    const fresh = { name: 'cashflow', last_checked: '2026-09-13T12:00:00Z', limits_cpu: '4', limits_memory: '4GB', device_eth0_ipv4_address: '192.0.2.2', profiles: [], ephemeral: 'false', stateful: 'false' }
