...
test('dwm analyst portal keeps alert triage primary while disclosing route setup', async () => {
    ...
    expect(page).toContain('const DWM_TIMELINE_PREVIEW_ROWS = 4')
    expect(page).toContain('const DWM_RECOVERY_PREVIEW_ROWS = 3')
    expect(page).toContain('const DWM_DELIVERY_PREVIEW_ROWS = 3')
