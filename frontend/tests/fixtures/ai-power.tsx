...
const client = {name:'Test worker',ram:[],cpu:[],gpu:[],lanes:[],model:defaultModelMetrics(), power:missing ? undefined : {totalWatts:461.5,monthlyKwh:1.25,sampledAt:new Date().toISOString()}} as GPT_Client
