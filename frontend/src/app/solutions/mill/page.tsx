                ...
                <div className='mx-auto grid max-w-7xl gap-8 px-4 py-16 md:px-8 md:py-24'>
                    <div className='grid max-w-4xl gap-5'>
                        ...
                        <div className='flex flex-wrap gap-3'>
                            <Link href='/cases' className='inline-flex h-11 items-center gap-2 rounded-lg bg-ui-text px-4 text-sm font-semibold text-ui-canvas'>Open cases <ArrowRight className='h-4 w-4' /></Link>
