...
const sourceProofProxyPayload = {
    ...
    contracts: {
        schemaLookup: {
            ...
            rows: [{
                schemaId: 'ti.source_provenance_source_activation_decision_receipt.v1',
                contractId: 'source_provenance_receipts',
                ownerLane: 'source',
                route: '/v1/dwm/source-requests/readiness',
                scopeFields: ['tenantId', 'organizationId', 'sourceIds'],
                blockerCodes: ['source_inactive'],
                downstreamConsumers: [{ ownerLane: 'alert', route: '/v1/dwm/alerts/rebuild', requiredFields: ['sourceIds', 'captureIds'] }],
