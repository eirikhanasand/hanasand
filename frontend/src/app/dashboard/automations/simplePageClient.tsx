...
function certLabel(automation: AgentAutomation) {
    ...
    if (automation.certificateStatus === 'not_applicable' || automation.monitoringType === 'tcp' || automation.monitoringType === 'ssh') return 'Not applicable'
