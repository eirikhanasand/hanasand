    ...
    return (
        <DashboardPage>
            ...
            <div className='grid gap-2 sm:grid-cols-2 xl:grid-cols-5'>
                ...
                <Metric title='Audit service' value={operationalStateLabel(worker.state)} tone={worker.state === 'ready' || worker.state === 'running' ? 'ok' : worker.state === 'error' || worker.state === 'unavailable' ? 'bad' : 'watch'} icon={<Radio className='h-4 w-4' />} />
                    ...
                    <div className='border-b border-ui-border bg-ui-raised px-3 py-2'>
                        <div className='flex flex-wrap items-center justify-between gap-2'>
                            ...
                            <div className='flex flex-wrap gap-1.5 text-[11px] font-semibold'>
                                <StatusPill label={`audit service ${operationalStateLabel(worker.state)}`} tone={worker.state === 'ready' || worker.state === 'running' ? 'ok' : 'watch'} />
