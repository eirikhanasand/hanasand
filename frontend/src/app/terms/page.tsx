    ...
    return (
        <LegalPage
            ...
            sections={[
                ...
                { title: 'Accounts and access', body: 'Keep credentials private, restrict access to people who need the product, and contact support if an account or webhook endpoint should be disabled.' },
