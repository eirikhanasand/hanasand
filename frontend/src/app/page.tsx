        ...
        <main className='mx-auto flex min-h-full w-full max-w-6xl flex-col px-4 py-6 text-bright md:px-8 md:py-10'>
            ...
            <section className='grid min-h-[calc(100vh-8rem)] content-center gap-10'>
                <div className='max-w-3xl'>
                    ...
                    <h1 className='text-4xl font-semibold tracking-[-0.02em] text-bright md:text-6xl'>Hanasand</h1>
                    ...
                    <div className='mt-7 flex flex-wrap gap-3'>
                        <Link href='/login' className='inline-flex items-center gap-2 rounded-full border border-bright/12 bg-bright/10 px-4 py-2.5 text-sm font-medium text-bright transition-colors hover:bg-bright/14'>
                            <KeyRound className='h-4 w-4' />
                            Log in
                        </Link>
                        <Link href='/s' className='inline-flex items-center gap-2 rounded-full border border-bright/10 px-4 py-2.5 text-sm font-medium text-bright/70 transition-colors hover:bg-bright/8 hover:text-bright'>
                            Build
                    ...
                    {primaryTools.map((tool) => {
                        ...
                        return (
                            <Link
                                key={tool.href}
                                href={tool.href}
                                className='group glass-card rounded-3xl p-5 transition-colors hover:border-bright/18 hover:bg-bright/8'
                            >
                                <div className='flex items-start justify-between gap-4'>
                                    <div className='grid h-10 w-10 place-items-center rounded-2xl bg-bright/8 text-bright/70 transition-colors group-hover:text-bright'>
