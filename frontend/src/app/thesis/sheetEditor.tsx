...
export default function SheetEditor({ sheet, canEdit, onChange, actions, trailingActions, showInsertTable = true, contentOnly = false }: { contentOnly?: boolean, sheet: Sheet, canEdit: boolean, actions?: ReactNode, trailingActions?: ReactNode, showInsertTable?: boolean, onChange: (field: 'title' | 'body', value: string, group?: string) => void }) {
