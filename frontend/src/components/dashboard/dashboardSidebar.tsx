...
import { BrainCircuit, Database, DatabaseBackup, FileWarning, Gauge, Inbox, LayoutDashboard, Network, ScanSearch, ScrollText, Settings2, ShieldCheck, Sparkles, UserRound } from 'lucide-react'
