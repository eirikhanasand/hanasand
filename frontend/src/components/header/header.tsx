            ...
            <header className='fixed left-0 top-0 z-1000 w-full border-b border-[#e1e5ec] bg-white px-3 sm:px-5 md:px-10 lg:px-16 dark:border-[#243044] dark:bg-[#0e1520]'>
                <div className='mx-auto flex h-18 w-full max-w-7xl items-center justify-between gap-5'>
                    ...
                    <div className='flex items-center justify-end gap-2'>
                        <ThemeSwitch />
                        <Link href='/contact?intent=support' className='hidden h-10 items-center rounded-lg px-3 text-sm font-semibold text-[#2f3540] transition hover:bg-[#f1f4f8] md:inline-flex dark:text-[#d9e2f2] dark:hover:bg-white/8 dark:hover:text-white'>Support</Link>
