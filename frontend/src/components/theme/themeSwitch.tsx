...
export default function ThemeSwitch() {
    ...
    return (
        <button
            type='button'
            className='group grid h-10 w-14 shrink-0 place-items-center rounded-lg border border-ui-border text-ui-muted transition hover:bg-ui-raised hover:text-ui-text focus:outline-none focus-visible:ring-2 focus-visible:ring-ui-primary/30 focus-visible:ring-offset-2 focus-visible:ring-offset-ui-canvas'
            aria-label={label}
