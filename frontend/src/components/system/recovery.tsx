...
export default function RecoveryPanel() {
    ...
    return <section aria-label='Overview' className='min-w-0 space-y-3 rounded-xl border border-ui-border bg-ui-panel p-4 text-ui-text shadow-sm sm:p-5 [overflow-wrap:anywhere]'>
        ...
        {!state ? <p>Loading service status…</p> : <>
            ...
            <div className='hidden overflow-x-auto xl:block' data-recovery-table><table className='w-full text-sm text-left'><thead><tr><th className='p-2'>Service</th><th className='p-2'>Serving from</th><th className='p-2'>Endpoint</th><th className='p-2'>Instances</th></tr></thead><tbody>
