...
The corrected production scheduler first shipped at `e7aae5ba71e5a1a4a74111f62d0322e54fc9949d`; the current scraper image contains the follow-through at `b64cdf05428dc2f6b5f60f258a6c348026a55060`. At 2026-08-09T06:47Z, PostgreSQL reported 9 governed Tor portfolio candidates, 6 with one current productive scheduled cycle, 2 with an approved source review, and 0 with the complete two-cycle qualification proof. Three additional active Tor rows are a transport canary or legacy rows and do not qualify. The remaining gap is 1,000.
