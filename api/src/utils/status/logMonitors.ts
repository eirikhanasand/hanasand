...
const monitors: MonitorDefinition[] = [
    {
        ...
        okMessage: 'No share page 4xx/5xx responses in the recent log window.',
    },
    {
        service: 'realtime',
        checkName: 'Websocket failures',
        category: 'websocket_failure',
        okMessage: 'No websocket failures in the recent log window.',
    },
    {
        service: 'terminal',
        checkName: 'Terminal failures',
        category: 'terminal_failure',
        okMessage: 'No terminal failures in the recent log window.',
    },
    {
        service: 'vm',
        checkName: 'VM provisioning errors',
        category: 'vm_provisioning_error',
        okMessage: 'No VM provisioning errors in the recent log window.',
    },
]
...
async function runMonitor(monitor: MonitorDefinition) {
    ...
    await run(`
        ...
        VALUES ($1, $2, $3, 0, $4)
    `, [monitor.service, monitor.checkName, status, message])
}
