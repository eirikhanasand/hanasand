...
expect(replayDestinationTest.dryRunPayloadPreview?.context.orgId === 'org_contract' && replayDestinationTest.dryRunPayloadPreview.context.sourceFamily === 'dark_web' && replayDestinationTest.dryRunPayloadPreview.context.analystLink === '/dashboard/dwm' && Boolean(replayDestinationTest.dryRunPayloadPreview.context.matchReason), 'Destination test payload preview should carry org/source/action-link and match-reason context.', replayDestinationTest.dryRunPayloadPreview)
