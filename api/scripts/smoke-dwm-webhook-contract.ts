...
expect(adminDisabledLifecycle?.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.consumesSchemaVersion === 'organization.lifecycle_settings_mutation_receipt.v1' && adminDisabledLifecycle.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.route.includes('/api/organizations/org_contract/settings'), 'Destination lifecycle receipt should expose the organization lifecycle settings consumer route.', adminDisabledLifecycle?.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer)
expect(adminDisabledLifecycle?.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.expectedDownstreamFields.includes('settingsMutationReceipt.downstreamReadiness.webhookDeliveryReady') && adminDisabledLifecycle.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.deliveryBlockers.archived === 'org_archived', 'Organization lifecycle settings consumer should expose webhook delivery readiness fields and blockers.', adminDisabledLifecycle?.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer)
expect(adminDisabledLifecycle?.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.mutationPreview.archive.expectedWebhookDeliveryReady === false && adminDisabledLifecycle.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.mutationPreview.reactivate.expectedWebhookDeliveryReady === true, 'Organization lifecycle settings consumer should expose archive/reactivate delivery readiness expectations.', adminDisabledLifecycle?.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.mutationPreview)
expect(adminDisabledLifecycle?.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.redaction.webhookSecretExposed === false, 'Organization lifecycle settings consumer should keep webhook secrets redacted.', adminDisabledLifecycle?.lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer)
...
expect(deliveryReceiptReplay?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.consumesSchemaVersion === 'dwm.case_webhook_replay_readiness_response.v1' && deliveryReceiptReplay.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.route.includes('/v1/cases/case_replay_contract/webhook-replay-readiness'), 'Case action dry-run receipts should expose case webhook replay readiness consumers.', deliveryReceiptReplay?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer)
expect(deliveryReceiptReplay?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.webhookContext.dedupeKey === 'dwm_dedupe_replay_contract' && deliveryReceiptReplay.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.webhookContext.auditEventId === 'audit_replay_duplicate_contract', 'Case webhook replay readiness consumers should carry webhook dedupe and audit context.', deliveryReceiptReplay?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer)
expect(deliveryReceiptRetry?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.deliveryState.retryable === true && deliveryReceiptRetry.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.deliveryState.nextRetryAt === '2026-06-28T12:11:00.000Z', 'Case webhook replay readiness consumers should carry retry/backoff state.', deliveryReceiptRetry?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer)
expect(deliveryReceiptRetry?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.nextWebhookActionIds.includes('retry_webhook_delivery') && deliveryReceiptRetry.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.roleGates.retry.includes('admin'), 'Case webhook replay readiness consumers should expose replay/retry action ids and role gates.', deliveryReceiptRetry?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer)
expect(deliveryReceiptRetry?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.redaction.webhookSecretExposed === false, 'Case webhook replay readiness consumers should keep webhook secrets redacted.', deliveryReceiptRetry?.transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer)
...
console.log(JSON.stringify({
    ...
    worker3Probe: {
        ...
        expectedFields: [
            ...
            'destinationLifecycle[].lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.consumesSchemaVersion',
            'destinationLifecycle[].lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.expectedDownstreamFields',
            'destinationLifecycle[].lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.deliveryBlockers.archived',
            'destinationLifecycle[].lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.mutationPreview.archive.expectedWebhookDeliveryReady',
            'destinationLifecycle[].lifecycleReadinessReceipt.organizationLifecycleSettingsConsumer.redaction.webhookSecretExposed',
            ...
            'deliveryReceipts.receipts[].transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.consumesSchemaVersion',
            'deliveryReceipts.receipts[].transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.route',
            'deliveryReceipts.receipts[].transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.webhookContext.dedupeKey',
            'deliveryReceipts.receipts[].transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.deliveryState.nextRetryAt',
            'deliveryReceipts.receipts[].transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.nextWebhookActionIds',
            'deliveryReceipts.receipts[].transitionReceipt.caseActionDryRunReceipt.caseWebhookReplayReadinessConsumer.redaction.webhookSecretExposed',
