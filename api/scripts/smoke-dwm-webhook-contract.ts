...
expect(replayDestinationTest.dryRunPayloadPreview?.context.orgId === 'org_contract' && replayDestinationTest.dryRunPayloadPreview.context.sourceFamily === 'dark_web' && replayDestinationTest.dryRunPayloadPreview.context.analystLink === '/dashboard/dwm' && Boolean(replayDestinationTest.dryRunPayloadPreview.context.matchReason) && Boolean(replayDestinationTest.dryRunPayloadPreview.context.evidenceTimestamp), 'Destination test payload preview should carry org/source/action-link, match-reason, and evidence-timestamp context.', replayDestinationTest.dryRunPayloadPreview)
