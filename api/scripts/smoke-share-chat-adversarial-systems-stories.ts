...
const stories: Story[] = [
    ...
    { id: 251, title: 'Mobile Refresh Data Contract Site', kind: 'website', prompt: 'Build a mobile refresh data contract page explaining backend contract state ownership autosave boundary second-device behavior rollback and failure owner.', mustMention: [/Backend contract/i, /Second device test|second-device/i, /Rollback path|Rollback plan/i, /Failure owner/i, /authentication, payments, and persistent data require a separate implementation/i] },
