...
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.schemaVersion, 'organization.invite_acceptance_downstream_grant.v1')
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.organizationId, organization.id)
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.appliedRole, 'member')
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.grantsConsumerAccess, true)
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.sharedWatchlistReadReady, true)
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.alertGenerationExportReady, false)
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.caseVisibilityReady, true)
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.webhookDeliveryReady, false)
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.blockerReason, null)
assert.ok(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.downstreamContracts.includes('organization.webhook_destination_delivery_consumer.v1'))
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.destinationReadiness.destinationOwnerField, 'destination.org_id')
assert.equal(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.destinationReadiness.crossOrgDestinationAllowed, false)
assert.ok(accepted.inviteAcceptance.consumerVisibilityReceipt.downstreamReadinessGrant.noLeakFields.includes('otherOrg.watchlistItemIds'))
...
assert.equal(revokedInviteAction.downstreamReadinessReceipt.schemaVersion, 'organization.invite_downstream_readiness_receipt.v1')
assert.equal(revokedInviteAction.downstreamReadinessReceipt.inviteStatus, 'revoked')
assert.equal(revokedInviteAction.downstreamReadinessReceipt.grantsConsumerAccess, false)
assert.equal(revokedInviteAction.downstreamReadinessReceipt.blockerReason, 'member_revoked')
assert.equal(revokedInviteAction.downstreamReadinessReceipt.readiness.alertGenerationReady, false)
assert.equal(revokedInviteAction.downstreamReadinessReceipt.readiness.webhookDeliveryReady, false)
assert.ok(revokedInviteAction.downstreamReadinessReceipt.downstreamContracts.includes('organization.webhook_destination_delivery_consumer.v1'))
assert.ok(revokedInviteAction.downstreamReadinessReceipt.requiredAcceptedMembershipFields.includes('destinationReadiness'))
assert.equal(revokedInviteAction.downstreamReadinessReceipt.destinationReadiness.deliveryBlockedUntilAccepted, true)
assert.equal(revokedInviteAction.downstreamReadinessReceipt.lifecycleCleanup.revokedInviteBlocker, 'member_revoked')
assert.equal(revokedInviteAction.downstreamReadinessReceipt.lifecycleCleanup.noCrossOrgLeakage, true)
assert.ok(revokedInviteAction.downstreamReadinessReceipt.noLeakFields.includes('otherOrg.watchlistItemIds'))
...
assert.equal(resentInviteAction.downstreamReadinessReceipt.inviteStatus, 'pending')
assert.equal(resentInviteAction.downstreamReadinessReceipt.blockerReason, 'invite_pending')
assert.equal(resentInviteAction.downstreamReadinessReceipt.acceptanceRequired, true)
assert.equal(resentInviteAction.downstreamReadinessReceipt.readiness.sharedWatchlistReadReady, false)
assert.equal(resentInviteAction.downstreamReadinessReceipt.lifecycleCleanup.resendIdempotent, true)
assert.equal(resentInviteAction.downstreamReadinessReceipt.destinationReadiness.nonmemberDestinationEnumeration, false)
...
assert.equal(ownerRoleChange.consumerVisibilityReceipt.routes.webhookDelivery, 'POST /v1/dwm/webhooks/deliver')
...
assert.ok(ownerRoleChange.consumerVisibilityReceipt.consumerContracts.includes('organization.webhook_destination_access_decision.v1'))
assert.ok(ownerRoleChange.consumerVisibilityReceipt.consumerContracts.includes('organization.webhook_alert_delivery_readiness.v1'))
...
assert.equal(ownerRoleChange.consumerVisibilityReceipt.before.canDryRunWebhookDelivery, false)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.before.canReadWebhookDeliverySummary, true)
...
assert.equal(ownerRoleChange.consumerVisibilityReceipt.after.canDryRunWebhookDelivery, false)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.after.canReadWebhookDeliverySummary, true)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.deliveryReadiness.schemaVersion, 'organization.member_role_delivery_readiness.v1')
assert.equal(ownerRoleChange.consumerVisibilityReceipt.deliveryReadiness.contract, 'organization.webhook_alert_delivery_readiness.v1')
assert.deepEqual(ownerRoleChange.consumerVisibilityReceipt.deliveryReadiness.allowedRoles, ['owner', 'admin'])
assert.deepEqual(ownerRoleChange.consumerVisibilityReceipt.deliveryReadiness.deniedRoles, ['member', 'viewer'])
assert.equal(ownerRoleChange.consumerVisibilityReceipt.deliveryReadiness.destinationOrgField, 'destination.org_id')
assert.equal(ownerRoleChange.consumerVisibilityReceipt.deliveryReadiness.nonmemberDestinationEnumeration, false)
...
assert.equal(ownerRoleChange.consumerVisibilityReceipt.blockerCodes.webhookDelivery, 'role_not_allowed')
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.schemaVersion, 'organization.member_role_downstream_readiness_receipt.v1')
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.organizationId, organization.id)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.targetUserId, 'org_smoke_viewer')
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.previousRole, 'viewer')
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.newRole, 'member')
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.roleChanged, true)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.before.sharedWatchlistReadReady, true)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.before.alertGenerationExportReady, false)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.after.sharedWatchlistReadReady, true)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.after.alertGenerationExportReady, false)
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.after.webhookDeliveryReady, false)
assert.ok(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.downstreamContracts.includes('organization.webhook_destination_delivery_consumer.v1'))
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.destinationReadiness.destinationOwnerField, 'destination.org_id')
assert.deepEqual(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.roleGates.webhookDelivery, ['owner', 'admin'])
assert.equal(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.lifecycleBlockers.roleNotAllowed, 'role_not_allowed')
assert.ok(ownerRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.noLeakFields.includes('otherOrg.alertGeneratorKeys'))
...
assert.equal(restoreRoleChange.consumerVisibilityReceipt.after.canDryRunWebhookDelivery, false)
assert.equal(restoreRoleChange.consumerVisibilityReceipt.deliveryReadiness.contract, 'organization.webhook_alert_delivery_readiness.v1')
assert.equal(restoreRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.previousRole, 'member')
assert.equal(restoreRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.newRole, 'viewer')
assert.equal(restoreRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.after.alertGenerationExportReady, false)
assert.equal(restoreRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.after.watchlistMutationReady, false)
assert.equal(restoreRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.after.deliverySummaryReady, true)
assert.equal(restoreRoleChange.consumerVisibilityReceipt.downstreamReadinessReceipt.destinationReadiness.nonmemberDestinationEnumeration, false)
...
assert.deepEqual(readiness.readinessProof.alertGenerationHandoff.replaySteps, ['export_alert_terms', 'match_retained_capture', 'persist_org_alert', 'verify_case_visibility', 'deliver_webhook', 'archive_cleanup'])
...
assert.equal(adminAlertCaseVisibility.workflowState.caseRecord.casePathTemplate, '/dwm?organizationId=:organizationId&watchlistItemId=:watchlistItemId')
...
assert.equal(adminAlertCaseVisibility.caseWorkflow.casePathTemplate, '/dwm?organizationId=:organizationId&watchlistItemId=:watchlistItemId')
...
assert.equal(adminAlertCaseVisibility.caseVisibilityConsumer.casePathTemplate, '/dwm?organizationId=:organizationId&watchlistItemId=:watchlistItemId')
...
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.schemaVersion, 'organization.webhook_destination_delivery_consumer.v1')
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.organizationId, organization.id)
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.tenantId, organization.id)
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.route, 'POST /v1/dwm/webhooks/deliver')
assert.deepEqual(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.actor, { userId: 'org_smoke_admin', role: 'admin', status: 'active' })
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.readyForDelivery, false)
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.destinationDeliveryReady, false)
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.dryRunReady, true)
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.blockerReason, 'manual_webhook_selection_required')
assert.deepEqual(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.roleGates.manualTrigger, ['owner', 'admin'])
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.destinationScope.selectedDestinationOrgField, 'destination.org_id')
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.destinationScope.crossOrgDestinationAllowed, false)
assert.equal(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.destinationScope.nonmemberDestinationEnumeration, false)
assert.deepEqual(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.map((match: Row) => match.watchlistItemId).sort(), alertTermsExport.activeTerms.map((term: Row) => term.watchlistItemId).sort())
assert.ok(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.every((match: Row) => match.matchReason.code === 'organization_watchlist_term_match'))
assert.ok(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.every((match: Row) => match.provenanceHash))
assert.ok(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.every((match: Row) => match.workflowStatus === 'blocked'))
assert.ok(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.every((match: Row) => match.destinationReadiness.blockerReason === 'manual_webhook_selection_required'))
assert.ok(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.lifecycleBlockers.includes('member_revoked'))
assert.ok(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.blockerCodes.includes('manual_webhook_selection_required'))
assert.ok(alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.noLeakFields.includes('destination.secret'))
...
assert.equal(alertTermsExport.sharedWatchlistDownstreamProof.caseBridge.caseWorkflowContract.casePathTemplate, '/dwm?organizationId=:organizationId&watchlistItemId=:watchlistItemId')
...
assert.equal(alertTermsExport.sharedWatchlistIntegrationGuardrails.caseSafety.casePathTemplate, '/dwm?organizationId=:organizationId&watchlistItemId=:watchlistItemId')
...
assert.equal(alertTermsExport.alertCasePersistenceReceipt.casePathTemplate, '/dwm?organizationId=:organizationId&watchlistItemId=:watchlistItemId')
...
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.schemaVersion, 'organization.lifecycle_settings_mutation_receipt.v1')
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.previousLifecycleStatus, 'active')
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.lifecycleStatus, 'archived')
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.lifecycleChanged, true)
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.blockerReason, 'org_archived')
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.downstreamReadiness.alertGenerationReady, false)
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.downstreamReadiness.webhookDeliveryReady, false)
assert.ok(archivedOrganizationSettings.settingsMutationReceipt.downstreamContracts.includes('organization.webhook_destination_delivery_consumer.v1'))
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.lifecycleCleanup.noCrossOrgLeakage, true)
assert.equal(archivedOrganizationSettings.settingsMutationReceipt.destinationReadiness.deliveryBlockedByLifecycle, true)
assert.ok(archivedOrganizationSettings.settingsMutationReceipt.noLeakFields.includes('destination.secret'))
...
assert.equal(deletedOrganizationSettings.settingsMutationReceipt.previousLifecycleStatus, 'archived')
assert.equal(deletedOrganizationSettings.settingsMutationReceipt.lifecycleStatus, 'deleted')
assert.equal(deletedOrganizationSettings.settingsMutationReceipt.blockerReason, 'org_deleted')
assert.equal(deletedOrganizationSettings.settingsMutationReceipt.downstreamReadiness.inviteMutationAllowed, false)
assert.equal(deletedOrganizationSettings.settingsMutationReceipt.downstreamReadiness.caseVisibilityReady, false)
assert.equal(deletedOrganizationSettings.settingsMutationReceipt.lifecycleCleanup.deletedBlocker, 'org_deleted')
assert.equal(deletedOrganizationSettings.settingsMutationReceipt.destinationReadiness.nonmemberDestinationEnumeration, false)
...
assert.equal(parseBody(reactivateOrganizationResponse.body).settingsMutationReceipt.previousLifecycleStatus, 'deleted')
assert.equal(parseBody(reactivateOrganizationResponse.body).settingsMutationReceipt.lifecycleStatus, 'active')
assert.equal(parseBody(reactivateOrganizationResponse.body).settingsMutationReceipt.blockerReason, null)
assert.equal(parseBody(reactivateOrganizationResponse.body).settingsMutationReceipt.downstreamReadiness.alertGenerationReady, true)
assert.equal(parseBody(reactivateOrganizationResponse.body).settingsMutationReceipt.downstreamReadiness.webhookDeliveryReady, true)
assert.equal(parseBody(reactivateOrganizationResponse.body).settingsMutationReceipt.destinationReadiness.deliveryBlockedByLifecycle, false)
...
assert.equal(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.organizationId, secondOrganization.id)
assert.equal(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.readyForDelivery, true)
assert.equal(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.destinationDeliveryReady, true)
assert.equal(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.blockerReason, null)
assert.deepEqual(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.blockerCodes, [])
assert.deepEqual(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.map((match: Row) => match.watchlistItemId), [secondOrgWatchlistItem.id])
assert.deepEqual(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.map((match: Row) => match.provenanceHash), secondOrgAlertTermsExport.alertGenerationConsumer.matchingInputReceipt.terms.map((term: Row) => term.provenanceHash))
assert.ok(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.every((match: Row) => match.workflowStatus === 'ready_for_delivery'))
assert.ok(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.every((match: Row) => match.destinationReadiness.destinationDeliveryReady === true))
assert.notDeepEqual(secondOrgAlertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.map((match: Row) => match.provenanceHash), alertTermsExport.webhookDestinationAccessDecision.deliveryConsumerReceipt.watchlistMatches.map((match: Row) => match.provenanceHash))
...
assert.equal(domainReference.alert.casePath, `/dwm?organizationId=${encodeURIComponent(organization.id)}&watchlistItemId=${encodeURIComponent(domainReference.watchlistItemId)}`)
...
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.schemaVersion, 'organization.watchlist_downstream_lifecycle_receipt.v1')
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.watchlistItemId, actorWatchlistItem.id)
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.statusAfter, 'archived')
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.workflowStatus, 'excluded_from_matching')
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.alertGenerationReadyAfter, false)
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.caseReplayReadyAfter, false)
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.webhookDeliveryReadyAfter, false)
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.lifecycleBlockerAfter, 'watchlist_archived')
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.destinationReadiness.blockerCode, 'watchlist_archived')
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.destinationReadiness.deliveryBlockedByLifecycle, true)
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.consumerContracts.alertGeneration, 'organization.watchlist_alert_generation_consumer.v1')
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.consumerContracts.caseVisibility, 'organization.case_visibility_consumer.v1')
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.consumerContracts.webhookAlertDeliveryReadiness, 'organization.webhook_alert_delivery_readiness.v1')
assert.ok(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.matchProvenance.requiredFields.includes('provenanceHash'))
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.lifecycleCleanup.cleanupRequired, true)
assert.equal(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.lifecycleCleanup.lookupDenialBlockerAfter, 'watchlist_not_found_or_cross_org')
assert.ok(parseBody(ownerDisablesActorResponse.body).operation.downstreamLifecycleReceipt.noLeakFields.includes('destination.secret'))
...
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.statusAfter, 'active')
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.workflowStatus, 'ready_for_matching')
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.alertGenerationReadyAfter, true)
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.caseReplayReadyAfter, true)
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.webhookDeliveryReadyAfter, true)
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.lifecycleBlockerAfter, null)
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.destinationReadiness.deliveryBlockedByLifecycle, false)
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.lifecycleCleanup.cleanupRequired, false)
assert.equal(parseBody(restoreArchivedWatchlistResponse.body).operation.downstreamLifecycleReceipt.lifecycleCleanup.noCrossOrgLeakage, true)
...
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.schemaVersion, 'organization.member_downstream_readiness_revocation.v1')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.organizationId, organization.id)
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.tenantId, organization.id)
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.targetUserId, 'org_smoke_viewer')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.targetRole, 'viewer')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.membershipStatusAfter, 'removed')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.blockerCode, 'member_revoked')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.ownerlessRecoveryMutationAllowed, false)
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.readiness.sharedWatchlistExportReady, false)
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.readiness.alertGenerationReady, false)
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.readiness.caseVisibilityReady, false)
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.readiness.webhookDeliveryReady, false)
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.readiness.supportRedactedReadReady, true)
assert.ok(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.requiredDownstreamFields.includes('provenanceHash'))
assert.ok(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.requiredDownstreamFields.includes('destinationReadiness'))
assert.ok(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.blockedConsumerContracts.includes('organization.alert_case_bridge_persistence_receipt.v1'))
assert.ok(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.blockedConsumerContracts.includes('organization.webhook_alert_delivery_readiness.v1'))
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.downstreamRoutes.alertCaseVisibility, 'GET /api/organizations/:id/alert-case-visibility')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.downstreamRoutes.webhookDelivery, 'POST /v1/dwm/webhooks/deliver')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.destinationReadiness.destinationOwnerField, 'destination.org_id')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.destinationReadiness.deliveryBlockedByLifecycle, true)
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.destinationReadiness.blockerReason, 'member_revoked')
assert.deepEqual(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.lifecycleCleanup.revokedInviteIds, [viewerPendingInviteBeforeRemoval.id])
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.lifecycleCleanup.staleInviteAcceptanceBlocker, 'member_revoked')
assert.equal(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.lifecycleCleanup.noCrossOrgLeakage, true)
assert.ok(removeViewerCleanup.consumerAccessRevocation.downstreamReadinessRevocation.noLeakFields.includes('otherOrg.destinationIds'))
