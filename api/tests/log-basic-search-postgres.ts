...
try {
    ...
    console.log(JSON.stringify({basic_search_postgres:true,full_result_parity_cases:searches.length,exact_count_parity:true,indexBuildMs,...shape,estimated_index_gib_at_2_8m:Number(estimatedGiB.toFixed(2)),insert_10000_ms:timings,combined_search_ms:plan[0]['Execution Time']}))
