export type ProgramFhHostedDefaultParserLift = {
  ...
  observedHostedRun: HostedParserObservedRun;
  requiredPaidFloor: { sellableRows: 100; sellableFindings: 52 };
  parserLift: HostedParserLiftCounts;
  projectedAfterParserLift: HostedParserProjection;
  countsTowardPaidPromotionNow: false;
  countsTowardHostedRerunExpectation: true;
  acceptedRowClasses: HostedParserAcceptedClass[];
  rejectionBuckets: HostedParserRejectionBucket[];
  noLeakBoundary: HostedParserNoLeakBoundary;
};

export type HostedParserLiftCounts = { caveatedRowsConverted: 54; newlyAdmittedSellableRows: 54; newlyAdmittedFindingRows: 21; sourceProvenanceRowsDoNotCountAsFindings: true };
export type HostedParserProjection = { sellableRows: 100; sellableFindings: 52; caveatedRows: 140; sellableGap: 0; findingGap: 0 };

export type HostedParserObservedRun = {
...
export type HostedParserAcceptedClass = {
...
export type HostedParserRejectionBucket = {
...
export type HostedParserNoLeakBoundary = {
