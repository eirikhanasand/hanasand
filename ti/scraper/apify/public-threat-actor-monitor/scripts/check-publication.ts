...
const contractMentions: Array<[string, string[]]> = [
  ...
  ["hosted paid readiness proof", ["hostedPaidReadinessProof", "ti.hosted_apify_paid_readiness_proof.v1", "ti.program_cp_hosted_paid_row_integrity_gate.v1", "secondBatchAudit", "check:hosted-apify-paid-readiness"]],
