...
export function contractIndex() {
  const routes = [
    ...
    route("GET", "/v1/intel/actor-profiles/:actorId/timeline"),
    route("GET", "/v1/intel/actor-enrichment/status"),
    route("GET", "/v1/intel/actor-enrichment/runs"),
    route("POST", "/v1/intel/actor-enrichment/runs"),
    ...
    route("GET", "/v1/intel/source-quality"),
    route("GET", "/v1/intel/actor-coverage"),
    route("GET", "/v1/intel/query-coverage"),
