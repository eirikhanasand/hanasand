...
const PHRASES: Array<[RegExp, string]> = [
  ...
  [/\b(published a new victim|new victim|victim\s*:|ransomware\.live)\b/i, "victim"],
  [/\b(published a new victim|new victim|victim\s*:|ransomware\.live)\b/i, "extortion"],
  [/\b(published a new victim|new victim|victim\s*:|ransomware\.live)\b/i, "leak"],
