    ...
    const store = {
      querySourceOperationalPage: async (input: any) => {
        ...
        return {
          ...
          totals: { sourceCount: 1, activeSourceCount: 1, retainedSourceCount: 1, inactiveSourceCount: 0, candidateSourceCount: 0, rejectedSourceCount: 0, sustainedUsefulSourceCount: 1, operationalMetricsMeasured: false },
          total: 1
        };
      },
