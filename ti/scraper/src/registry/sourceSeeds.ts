...
const PAID_ACTOR_PROJECTED_ROWS_AFTER_PARSER_ADMISSION = 300;
const PAID_ACTOR_NEXT_SELLABLE_ROW_GATE = 300;
const PAID_ACTOR_REMAINING_ROWS_AFTER_PARSER_ADMISSION =
  Math.max(0, PAID_ACTOR_NEXT_SELLABLE_ROW_GATE - PAID_ACTOR_PROJECTED_ROWS_AFTER_PARSER_ADMISSION);
...
const ENTERPRISE_SAFE_PUBLIC_SOURCE_TEMPLATES: Array<{
  ...
  { name: "Mandiant Threat Intelligence", category: "vendor_blog", url: "https://cloud.google.com/blog/topics/threat-intelligence/rss/", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["APT29", "APT42", "Sandworm", "Lazarus"], expectedRowType: "campaign_report", parserPath: "rss", buyerUse: "Fresh actor campaign, TTP, victim-sector, and malware rows from high-confidence vendor research.", freshnessCadenceSeconds: 21600 },
  { name: "Microsoft Threat Intelligence Blog", category: "vendor_blog", url: "https://www.microsoft.com/en-us/security/blog/microsoft-threat-intelligence/feed/", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["APT29", "APT28", "Volt Typhoon", "Scattered Spider"], expectedRowType: "actor_activity", parserPath: "rss", buyerUse: "Current named-actor activity, sectors, tools, and mitigations for paid Actor rows.", freshnessCadenceSeconds: 21600 },
  { name: "Google Threat Analysis Group", category: "vendor_blog", url: "https://blog.google/threat-analysis-group/rss/", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["APT29", "APT42", "North Korea", "China-nexus"], expectedRowType: "actor_activity", parserPath: "rss", buyerUse: "Named actor targeting and campaign updates with direct buyer triage value.", freshnessCadenceSeconds: 21600 },
  { name: "Cisco Talos Intelligence", category: "vendor_blog", url: "https://blog.talosintelligence.com/rss/", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["Lazarus", "APT28", "LockBit", "Akira"], expectedRowType: "malware_infrastructure", parserPath: "rss", buyerUse: "Malware, infrastructure, and campaign context for actor and tool rows.", freshnessCadenceSeconds: 21600 },
  { name: "Palo Alto Unit 42", category: "vendor_blog", url: "https://unit42.paloaltonetworks.com/feed/", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["APT29", "APT42", "LockBit", "Clop"], expectedRowType: "campaign_report", parserPath: "rss", buyerUse: "Actor reports and ransomware tradecraft with victim/sector extraction potential.", freshnessCadenceSeconds: 21600 },
  { name: "ESET WeLiveSecurity", category: "vendor_blog", url: "https://www.welivesecurity.com/en/rss/feed/", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["Sandworm", "Lazarus", "APT28", "Turla"], expectedRowType: "campaign_report", parserPath: "rss", buyerUse: "European and state-aligned campaign reports for actor freshness rows.", freshnessCadenceSeconds: 21600 },
  { name: "Sophos X-Ops", category: "vendor_blog", url: "https://news.sophos.com/en-us/category/threat-research/feed/", tags: ["actor", "malware", "ransomware", "vendor research"], actorGroups: ["LockBit", "Akira", "Black Basta", "Scattered Spider"], expectedRowType: "ransomware_victim", parserPath: "rss", buyerUse: "Ransomware and intrusion tradecraft rows with defensive context.", freshnessCadenceSeconds: 21600 },
  { name: "Secureworks Counter Threat Unit", category: "vendor_blog", url: "https://www.secureworks.com/research/rss", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["APT29", "APT28", "Volt Typhoon", "Iran-nexus"], expectedRowType: "actor_activity", parserPath: "rss", buyerUse: "Named threat group profiles and current activity suitable for actor rows.", freshnessCadenceSeconds: 21600 },
  { name: "CrowdStrike Counter Adversary", category: "vendor_blog", url: "https://www.crowdstrike.com/en-us/blog/category/threat-intel-research/feed/", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["Scattered Spider", "APT29", "Lazarus", "LockBit"], expectedRowType: "actor_activity", parserPath: "rss", buyerUse: "Adversary-named activity, tactics, and sector targeting for paid Actor output.", freshnessCadenceSeconds: 21600 },
  { name: "SentinelLabs Research", category: "vendor_blog", url: "https://www.sentinelone.com/labs/feed/", tags: ["actor", "malware", "campaign", "vendor research"], actorGroups: ["Lazarus", "Sandworm", "APT28", "Akira"], expectedRowType: "malware_infrastructure", parserPath: "rss", buyerUse: "Malware/tool and campaign rows with extractable infrastructure and TTPs.", freshnessCadenceSeconds: 21600 },
  { name: "CISA Cybersecurity Advisories", category: "advisory", url: "https://www.cisa.gov/news.xml", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT29", "Volt Typhoon", "LockBit", "Clop"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "Current exploited vulnerability, sector, and mitigation rows from US government advisories.", freshnessCadenceSeconds: 7200 },
  { name: "NCSC UK Advisories", category: "advisory", url: "https://www.ncsc.gov.uk/api/1/services/v1/all-rss-feed.xml", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT29", "APT28", "Russia-nexus", "China-nexus"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "UK government actor, vulnerability, and sector impact rows.", freshnessCadenceSeconds: 7200 },
  { name: "CERT-EU Security Advisories", category: "advisory", url: "https://cert.europa.eu/publications/security-advisories-rss", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT29", "APT28", "Sandworm", "Volt Typhoon"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "EU advisory rows with CVE, severity, and affected enterprise technology context.", freshnessCadenceSeconds: 7200 },
  { name: "JPCERT/CC Alerts", category: "advisory", url: "https://www.jpcert.or.jp/english/rss/jpcert.rdf", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["Lazarus", "APT10", "China-nexus", "North Korea"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Japan-region alert rows for actor, vulnerability, and sector pivots.", freshnessCadenceSeconds: 7200 },
  { name: "ACSC Alerts", category: "advisory", url: "https://www.cyber.gov.au/acsc/view-all-content/alerts/rss", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["Volt Typhoon", "APT40", "LockBit", "Akira"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Australia-region public alert rows for infrastructure and sector monitoring.", freshnessCadenceSeconds: 7200 },
  { name: "CERT-FR Alerts", category: "advisory", url: "https://www.cert.ssi.gouv.fr/feed/", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT28", "APT29", "LockBit", "Clop"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "French CERT CVE and campaign rows with current enterprise mitigation value.", freshnessCadenceSeconds: 7200 },
  { name: "BSI CERT-Bund Advisories", category: "advisory", url: "https://wid.cert-bund.de/content/public/securityAdvisory/rss", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT29", "APT28", "Black Basta", "LockBit"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "German government vulnerability rows for affected software and severity pivots.", freshnessCadenceSeconds: 7200 },
  { name: "CSA Singapore Advisories", category: "advisory", url: "https://www.csa.gov.sg/alerts-advisories/rss.xml", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["Volt Typhoon", "APT40", "Lazarus", "China-nexus"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Singapore-region advisory rows with sector and vulnerability context.", freshnessCadenceSeconds: 7200 },
  { name: "NCSC Norway Advisories", category: "advisory", url: "https://nsm.no/rss", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT29", "APT28", "Russia-nexus", "LockBit"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Norway-region public advisory rows for country and sector searches.", freshnessCadenceSeconds: 7200 },
  { name: "ENISA News and Threat Landscape", category: "advisory", url: "https://www.enisa.europa.eu/news/news-wires/RSS", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["LockBit", "Clop", "APT29", "APT28"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "EU threat landscape rows for sector, country, and ransomware trend coverage.", freshnessCadenceSeconds: 7200 },
  { name: "The DFIR Report", category: "rss", url: "https://thedfirreport.com/feed/", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["LockBit", "Akira", "Black Basta", "Scattered Spider"], expectedRowType: "campaign_report", parserPath: "rss", buyerUse: "Detailed intrusion timelines with TTP/tool extraction for buyer-ready rows.", freshnessCadenceSeconds: 21600 },
  { name: "Malwarebytes Labs", category: "rss", url: "https://www.malwarebytes.com/blog/feed", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["LockBit", "Akira", "Lazarus", "Scattered Spider"], expectedRowType: "malware_infrastructure", parserPath: "rss", buyerUse: "Malware and ransomware reports with practical defensive summaries.", freshnessCadenceSeconds: 21600 },
  { name: "KrebsOnSecurity", category: "rss", url: "https://krebsonsecurity.com/feed/", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["Scattered Spider", "Clop", "LockBit", "Black Basta"], expectedRowType: "ransomware_victim", parserPath: "rss", buyerUse: "Incident and cybercrime reporting with victim, sector, and fraud context.", freshnessCadenceSeconds: 21600 },
  { name: "SANS ISC Diary", category: "rss", url: "https://isc.sans.edu/rssfeed.xml", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["APT29", "LockBit", "Akira", "Cobalt Strike"], expectedRowType: "malware_infrastructure", parserPath: "rss", buyerUse: "Daily handler reports for exploit, malware, and infrastructure pivots.", freshnessCadenceSeconds: 21600 },
  { name: "BleepingComputer Security", category: "rss", url: "https://www.bleepingcomputer.com/feed/", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["LockBit", "Clop", "Akira", "Black Basta"], expectedRowType: "ransomware_victim", parserPath: "rss", buyerUse: "Current ransomware, breach, and exploitation rows with buyer-visible victim context.", freshnessCadenceSeconds: 21600 },
  { name: "Rapid7 Blog", category: "rss", url: "https://www.rapid7.com/blog/rss/", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["APT29", "Volt Typhoon", "LockBit", "Akira"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "Exploit and vulnerability research rows tied to remediation guidance.", freshnessCadenceSeconds: 21600 },
  { name: "Red Canary Research", category: "rss", url: "https://redcanary.com/feed/", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["Cobalt Strike", "Black Basta", "Scattered Spider", "Lazarus"], expectedRowType: "malware_infrastructure", parserPath: "rss", buyerUse: "Detection-focused tool and TTP rows for current actor tradecraft.", freshnessCadenceSeconds: 21600 },
  { name: "Proofpoint Threat Insight", category: "rss", url: "https://www.proofpoint.com/us/rss.xml", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["APT29", "APT28", "TA groups", "Scattered Spider"], expectedRowType: "actor_activity", parserPath: "rss", buyerUse: "Email threat and actor campaign rows with sector and lure extraction.", freshnessCadenceSeconds: 21600 },
  { name: "Elastic Security Labs", category: "rss", url: "https://www.elastic.co/security-labs/rss/feed.xml", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["Lazarus", "Sandworm", "Akira", "Cobalt Strike"], expectedRowType: "malware_infrastructure", parserPath: "rss", buyerUse: "Malware and infrastructure intelligence rows with technical detail.", freshnessCadenceSeconds: 21600 },
  { name: "Recorded Future Blog", category: "rss", url: "https://www.recordedfuture.com/feed", tags: ["rss", "incident", "ransomware", "malware"], actorGroups: ["APT29", "APT42", "LockBit", "Clop"], expectedRowType: "campaign_report", parserPath: "rss", buyerUse: "Strategic and operational threat rows for actor and sector watchlists.", freshnessCadenceSeconds: 21600 },
  { name: "GitHub Advisory Database", category: "github_security_advisory", url: "https://api.github.com/advisories", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "Volt Typhoon", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "official_api", buyerUse: "Public GHSA/CVE rows for vulnerable package and exploitability pivots.", freshnessCadenceSeconds: 7200, sourceType: "api" },
  { name: "GitLab Security Advisories", category: "github_security_advisory", url: "https://advisories.gitlab.com/atom.xml", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "Volt Typhoon", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "GitLab ecosystem advisory rows for software exposure searches.", freshnessCadenceSeconds: 7200 },
  { name: "OSV Vulnerability Feed", category: "github_security_advisory", url: "https://api.osv.dev/v1/query", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "Volt Typhoon", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "official_api", buyerUse: "Open-source vulnerability rows for package, ecosystem, and CVE pivots.", freshnessCadenceSeconds: 7200, sourceType: "api" },
  { name: "RustSec Advisory Database", category: "github_security_advisory", url: "https://rustsec.org/advisories/", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "supply-chain actors", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "static_html", buyerUse: "Rust ecosystem advisory rows for supply-chain exposure checks.", freshnessCadenceSeconds: 21600, sourceType: "static_web" },
  { name: "PyPA Advisory Database", category: "github_security_advisory", url: "https://github.com/pypa/advisory-database", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "supply-chain actors", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "static_html", buyerUse: "Python package advisory rows for enterprise dependency risk pivots.", freshnessCadenceSeconds: 21600, sourceType: "static_web" },
  { name: "npm Security Advisories", category: "github_security_advisory", url: "https://github.com/advisories?query=ecosystem%3Anpm", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["Lazarus", "supply-chain actors", "APT29", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "static_html", buyerUse: "npm ecosystem advisory rows for supply-chain and exploit triage.", freshnessCadenceSeconds: 21600, sourceType: "static_web" },
  { name: "Go Vulnerability Database", category: "github_security_advisory", url: "https://pkg.go.dev/vuln/list", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Volt Typhoon", "supply-chain actors", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "static_html", buyerUse: "Go ecosystem vulnerability rows for affected package searches.", freshnessCadenceSeconds: 21600, sourceType: "static_web" },
  { name: "Maven Security Advisories", category: "github_security_advisory", url: "https://github.com/advisories?query=ecosystem%3Amaven", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "supply-chain actors", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "static_html", buyerUse: "Java ecosystem advisory rows for dependency and exploitability coverage.", freshnessCadenceSeconds: 21600, sourceType: "static_web" },
  { name: "OpenSSF Security Blog", category: "github_security_advisory", url: "https://openssf.org/blog/feed/", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["supply-chain actors", "Lazarus", "APT29", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "Supply-chain security rows with package ecosystem and mitigation context.", freshnessCadenceSeconds: 21600 },
  { name: "Kubernetes Security Announcements", category: "github_security_advisory", url: "https://kubernetes.io/docs/reference/issues-security/official-cve-feed/index.json", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Volt Typhoon", "cloud intrusion actors", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "official_api", buyerUse: "Kubernetes CVE rows for cloud and infrastructure exposure searches.", freshnessCadenceSeconds: 7200, sourceType: "api" },
  { name: "MITRE ATT&CK Updates", category: "public_research_feed", url: "https://attack.mitre.org/resources/updates/", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["APT29", "APT28", "Lazarus", "Volt Typhoon"], expectedRowType: "campaign_report", parserPath: "static_html", buyerUse: "Technique and actor update rows for ATT&CK-mapped buyer output.", freshnessCadenceSeconds: 21600, sourceType: "static_web" },
  { name: "Malpedia Feeds", category: "public_research_feed", url: "https://malpedia.caad.fkie.fraunhofer.de/feeds/rss", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["Lazarus", "Sandworm", "APT28", "Cobalt Strike"], expectedRowType: "malware_infrastructure", parserPath: "rss", buyerUse: "Malware family and actor-linked tooling rows for technical pivots.", freshnessCadenceSeconds: 21600 },
  { name: "Abuse.ch URLhaus", category: "public_research_feed", url: "https://urlhaus.abuse.ch/feeds/recent/", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["ransomware operators", "Cobalt Strike", "Lazarus", "botnet operators"], expectedRowType: "malware_infrastructure", parserPath: "text_feed", buyerUse: "Recent malicious URL infrastructure rows for malware and campaign enrichment.", freshnessCadenceSeconds: 7200, sourceType: "api" },
  { name: "Abuse.ch MalwareBazaar", category: "public_research_feed", url: "https://bazaar.abuse.ch/export/txt/recent/", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["Lazarus", "ransomware operators", "Cobalt Strike", "botnet operators"], expectedRowType: "malware_infrastructure", parserPath: "text_feed", buyerUse: "Recent malware sample metadata rows without payload retrieval.", freshnessCadenceSeconds: 7200, sourceType: "api" },
  { name: "AlienVault OTX Global Pulses", category: "public_research_feed", url: "https://otx.alienvault.com/browse/global/pulses", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["APT29", "APT42", "Lazarus", "LockBit"], expectedRowType: "campaign_report", parserPath: "static_html", buyerUse: "Public pulse metadata rows for actor, campaign, and infrastructure pivots.", freshnessCadenceSeconds: 21600, sourceType: "static_web" },
  { name: "OpenPhish Feed", category: "public_research_feed", url: "https://openphish.com/feed.txt", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["Scattered Spider", "phishing actors", "ransomware affiliates", "credential theft actors"], expectedRowType: "malware_infrastructure", parserPath: "text_feed", buyerUse: "Fresh phishing infrastructure rows for actor and sector triage.", freshnessCadenceSeconds: 7200, sourceType: "api" },
  { name: "PhishTank Verified", category: "public_research_feed", url: "https://phishtank.org/phish_search.php?valid=y&active=y", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["Scattered Spider", "phishing actors", "credential theft actors", "ransomware affiliates"], expectedRowType: "malware_infrastructure", parserPath: "static_html", buyerUse: "Verified phishing metadata rows for infrastructure and campaign enrichment.", freshnessCadenceSeconds: 7200, sourceType: "static_web" },
  { name: "Spamhaus DROP", category: "public_research_feed", url: "https://www.spamhaus.org/drop/drop.txt", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["botnet operators", "ransomware affiliates", "malware operators", "phishing actors"], expectedRowType: "malware_infrastructure", parserPath: "text_feed", buyerUse: "Network blocklist rows for infrastructure reputation and campaign context.", freshnessCadenceSeconds: 7200, sourceType: "api" },
  { name: "Shadowserver News", category: "public_research_feed", url: "https://www.shadowserver.org/news/feed/", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["botnet operators", "Volt Typhoon", "ransomware operators", "malware operators"], expectedRowType: "malware_infrastructure", parserPath: "rss", buyerUse: "Internet-scale exposure and malware reporting rows for infrastructure searches.", freshnessCadenceSeconds: 21600 },
  { name: "CIRCL OSINT Feed", category: "public_research_feed", url: "https://www.circl.lu/doc/misp/feed-osint/", tags: ["public research", "malware", "infrastructure", "campaign"], actorGroups: ["APT29", "APT42", "Lazarus", "LockBit"], expectedRowType: "campaign_report", parserPath: "static_html", buyerUse: "Public MISP/OSINT metadata rows for actor and campaign correlation.", freshnessCadenceSeconds: 21600, sourceType: "static_web" },
  { name: "US-CERT Current Activity", category: "government_cert", url: "https://www.cisa.gov/uscert/ncas/current-activity.xml", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["APT29", "Volt Typhoon", "LockBit", "Clop"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "US current activity rows for sectors, CVEs, and active exploitation.", freshnessCadenceSeconds: 7200 },
  { name: "CERT NZ Advisories", category: "government_cert", url: "https://www.cert.govt.nz/it-specialists/advisories/rss", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["Volt Typhoon", "LockBit", "Akira", "APT40"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "New Zealand regional advisory rows for sector and vulnerability searches.", freshnessCadenceSeconds: 7200 },
  { name: "CERT Polska Alerts", category: "government_cert", url: "https://cert.pl/en/rss/", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["APT28", "APT29", "Sandworm", "LockBit"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Poland-region public alert rows for Russian-nexus and ransomware tracking.", freshnessCadenceSeconds: 7200 },
  { name: "CERT-UA Advisories", category: "government_cert", url: "https://cert.gov.ua/api/articles/rss", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["Sandworm", "APT28", "Russia-nexus", "wiper malware"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Ukraine-region activity rows for destructive malware and government targeting.", freshnessCadenceSeconds: 7200 },
  { name: "CERT-In Advisories", category: "government_cert", url: "https://www.cert-in.org.in/RssFeed.xml", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["APT36", "Lazarus", "Volt Typhoon", "ransomware operators"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "India-region advisory rows for country and sector pivots.", freshnessCadenceSeconds: 7200 },
  { name: "CERT-SE Advisories", category: "government_cert", url: "https://www.cert.se/feed/", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["APT29", "APT28", "LockBit", "Akira"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Sweden-region advisory rows for vulnerability and sector impact.", freshnessCadenceSeconds: 7200 },
  { name: "NorCERT Advisories", category: "government_cert", url: "https://nsm.no/rss", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["APT29", "APT28", "LockBit", "Russia-nexus"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Norway-region CERT rows for local country and sector searches.", freshnessCadenceSeconds: 7200 },
  { name: "FinCERT Advisories", category: "government_cert", url: "https://www.kyberturvallisuuskeskus.fi/en/rss.xml", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["APT29", "APT28", "LockBit", "Russia-nexus"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Finland-region advisory rows for sector and exploitation monitoring.", freshnessCadenceSeconds: 7200 },
  { name: "CERT-LV Advisories", category: "government_cert", url: "https://cert.lv/en/feed", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["APT28", "APT29", "Sandworm", "Russia-nexus"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Latvia-region advisory rows for country-specific threat monitoring.", freshnessCadenceSeconds: 7200 },
  { name: "GovCERT.ch Blog", category: "government_cert", url: "https://www.govcert.ch/blog/rss.xml", tags: ["government CERT", "country", "sector", "advisory"], actorGroups: ["APT29", "APT28", "LockBit", "banking malware"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Swiss government reporting rows for financial-sector and malware coverage.", freshnessCadenceSeconds: 7200 }
];
...
function activationExecutionSource(
  ...
  return {
    ...
    actorGroups: source.actorGroups,
    expectedRowType: source.expectedRowType,
    parserPath: source.parserPath,
    buyerUse: source.buyerUse,
    freshnessCadenceSeconds: source.freshnessCadenceSeconds,
...
function enterpriseActivationWaveSource(
  ...
  const sourceType: SourceType = template.sourceType ?? (template.parserPath === "official_api" || template.parserPath === "text_feed" ? "api" : template.parserPath === "static_html" ? "static_web" : "rss");
  const cadence = template.freshnessCadenceSeconds;
  ...
  return {
    ...
    actorGroups: template.actorGroups,
    expectedRowType: template.expectedRowType,
    parserPath: template.parserPath,
    buyerUse: template.buyerUse,
    ...
    safePublicRationale: [
      ...
      `actors:${template.actorGroups.slice(0, 4).join(",")}`,
      `row_type:${template.expectedRowType}`,
      `parser:${template.parserPath}`,
      `buyer_use:${template.buyerUse}`
    ]
  };
}
