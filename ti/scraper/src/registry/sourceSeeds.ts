...
const ENTERPRISE_SAFE_PUBLIC_SOURCE_TEMPLATES: Array<{
  ...
  { name: "JPCERT/CC Alerts", category: "advisory", url: "https://www.jpcert.or.jp/english/rss/jpcert.rdf", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["Lazarus", "APT10", "China-nexus", "North Korea"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Japan-region alert rows for actor, vulnerability, and sector pivots.", freshnessCadenceSeconds: 3600 },
  { name: "ACSC Alerts", category: "advisory", url: "https://www.cyber.gov.au/acsc/view-all-content/alerts/rss", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["Volt Typhoon", "APT40", "LockBit", "Akira"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Australia-region public alert rows for infrastructure and sector monitoring.", freshnessCadenceSeconds: 3600 },
  { name: "CERT-FR Alerts", category: "advisory", url: "https://www.cert.ssi.gouv.fr/feed/", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT28", "APT29", "LockBit", "Clop"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "French CERT CVE and campaign rows with current enterprise mitigation value.", freshnessCadenceSeconds: 3600 },
  { name: "BSI CERT-Bund Advisories", category: "advisory", url: "https://wid.cert-bund.de/content/public/securityAdvisory/rss", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT29", "APT28", "Black Basta", "LockBit"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "German government vulnerability rows for affected software and severity pivots.", freshnessCadenceSeconds: 3600 },
  ...
  { name: "NCSC Norway Advisories", category: "advisory", url: "https://nsm.no/rss", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["APT29", "APT28", "Russia-nexus", "LockBit"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "Norway-region public advisory rows for country and sector searches.", freshnessCadenceSeconds: 3600 },
  { name: "ENISA News and Threat Landscape", category: "advisory", url: "https://www.enisa.europa.eu/news/news-wires/RSS", tags: ["advisory", "CVE", "sector", "government"], actorGroups: ["LockBit", "Clop", "APT29", "APT28"], expectedRowType: "sector_country", parserPath: "rss", buyerUse: "EU threat landscape rows for sector, country, and ransomware trend coverage.", freshnessCadenceSeconds: 3600 },
  ...
  { name: "GitHub Advisory Database", category: "github_security_advisory", url: "https://api.github.com/advisories", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "Volt Typhoon", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "official_api", buyerUse: "Public GHSA/CVE rows for vulnerable package and exploitability pivots.", freshnessCadenceSeconds: 3600, sourceType: "api" },
  { name: "GitLab Security Advisories", category: "github_security_advisory", url: "https://advisories.gitlab.com/atom.xml", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "Volt Typhoon", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "rss", buyerUse: "GitLab ecosystem advisory rows for software exposure searches.", freshnessCadenceSeconds: 3600 },
  { name: "OSV Vulnerability Feed", category: "github_security_advisory", url: "https://api.osv.dev/v1/query", tags: ["github", "CVE", "vulnerability", "infrastructure"], actorGroups: ["APT29", "Lazarus", "Volt Typhoon", "ransomware operators"], expectedRowType: "cve_advisory", parserPath: "official_api", buyerUse: "Open-source vulnerability rows for package, ecosystem, and CVE pivots.", freshnessCadenceSeconds: 3600, sourceType: "api" },
