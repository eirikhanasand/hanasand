...
const BAD_RE = /\b(test fixture|example\.test|proof-only|synthetic|webinar|newsletter|conference|podcast|product launch|press release|request a demo|book a demo|schedule a demo|free \d+-day|free .* assessment|free .* trial|buyer'?s guide|whitepaper|case study|sponsored|award|awards|named top vendor|recognizes .* as the best|what is application security testing|what is managed cloud security|practical guide|why halcyon|mythos era|new standard for url analysis)\b/i;
const BAD_SOURCE_RE = /\bsrc_canary_halcyon\b/i;
