import { acceptedClass, rejection } from "./hostedDefaultParserLiftRows.ts";
...
export function buildProgramFhHostedDefaultParserLift(): ProgramFhHostedDefaultParserLift {
  return {
    ...
    rejectionBuckets: [rejection("stale_latest_activity", 41), rejection("alias_or_wrong_actor", 18), rejection("generic_source_page", 27), rejection("graph_only", 21), rejection("restricted_only", 39), rejection("duplicate_claim", 12), rejection("contradiction", 9)],
