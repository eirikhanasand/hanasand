...
import type {
  OfficialTelegramClient,
  OfficialTelegramSearchClient,
  SourceApprovalStateLike,
  TelegramAdapterFailureCategory,
  TelegramBotApiClientOptions,
  TelegramCrawlStateOutput,
  TelegramFetch,
  TelegramPaginationState,
  TelegramPublicAbuseControlDto,
  TelegramPublicAbuseControlInput,
  TelegramPublicActivationBridgeDto,
  TelegramPublicActivationChannelSummary,
  TelegramPublicActivationProgramDto,
  TelegramPublicActivationRecommendation,
  TelegramPublicActorReadinessDto,
  TelegramPublicAnswerReadinessDto,
  TelegramPublicApplyPlanAction,
  TelegramPublicApplyPlanApiContractDto,
  TelegramPublicApplyPlanDto,
  TelegramPublicApplyPlanExecution,
  TelegramPublicApplyPlanInput,
  TelegramPublicApplyPlanStep,
  TelegramPublicCanaryRolloutDto,
  TelegramPublicChannelDiagnostic,
  TelegramPublicChannelDiagnosticStatus,
  TelegramPublicChannelSearchHit,
  TelegramPublicChannelSourceModel,
  TelegramPublicCompactSearchSummaryDto,
  TelegramPublicCoverageGapExplanation,
  TelegramPublicCoverageGapReason,
  TelegramPublicCutoverNextAction,
  TelegramPublicCutoverReportDto,
  TelegramPublicCutoverReportInput,
  TelegramPublicEvidenceDto,
  TelegramPublicFetchRequest,
  TelegramPublicFetchResult,
  TelegramPublicForwardMetadata,
  TelegramPublicIncrementalPollDto,
  TelegramPublicIncrementalPollInput,
  TelegramPublicMediaMetadata,
  TelegramPublicMessage,
  TelegramPublicMessageSearchHit,
  TelegramPublicOperatorControlEffectDto,
  TelegramPublicOperatorState,
  TelegramPublicOperatorStateDto,
  TelegramPublicPromotionCanaryProofDto,
  TelegramPublicPromotionCertificationDto,
  TelegramPublicPromotionInput,
  TelegramPublicPromotionProgramDto,
  TelegramPublicPromotionProgramInput,
  TelegramPublicPromotionResult,
  TelegramPublicQueryWindowPlan,
  TelegramPublicReconciliationDto,
  TelegramPublicReconciliationInput,
  TelegramPublicReliabilityInput,
  TelegramPublicReliabilityRating,
  TelegramPublicReliabilityReportDto,
  TelegramPublicReliabilitySourceDto,
  TelegramPublicRepairAction,
  TelegramPublicRepairRecommendation,
  TelegramPublicRuntimeCollectionDto,
  TelegramPublicRuntimeCollectionInput,
  TelegramPublicRuntimeConnectorContractDto,
  TelegramPublicRuntimeStatus,
  TelegramPublicSchedulerState,
  TelegramPublicSearchBackfillPlan,
  TelegramPublicSearchInput,
  TelegramPublicSearchResultDto,
  TelegramPublicSlaReportDto,
  TelegramPublicSourceConfig,
  TelegramPublicSourceHealthUpdate,
  TelegramPublicSourcePack,
  TelegramPublicSourcePackCompatibilityDto,
  TelegramPublicSourcePackEntry,
  TelegramPublicSourcePackReadinessDto,
  TelegramPublicSourcePackRecommendation,
  TelegramPublicSourcePackValidation
} from "./telegramPublicTypes.ts";
