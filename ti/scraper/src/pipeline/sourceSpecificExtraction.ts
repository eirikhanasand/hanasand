...
export const SOURCE_SPECIFIC_EXTRACTOR_VERSION = "ti-source-specific-extractor-v7";
...
function victimBlogEntities(item: CollectedItem, context: ExtractionContext): ExtractedEntity[] {
  ...
  return compact([
    ...
    fieldEntity("publicity_tactic", fields.publicityTactic, 0.8, "publicityTactic", item, context, "source_claim", ["unverified threat-actor claim"]),
    fieldEntity("publication_strategy", fields.publicationStrategy, 0.8, "publicationStrategy", item, context, "source_claim", ["unverified threat-actor claim"]),
