...
const TECHNIQUES = ["phishing", "credential dumping", "credential theft", "valid accounts", "lateral movement", "remote desktop protocol", "powershell", "command and control", "exfiltration", "persistence", "spearphishing", "data exfiltration", "data theft", "sms phishing", "living off the land", "exploit", "intrusion", "mfa fatigue", "oauth abuse", "token theft", "password spraying", "remote services", "cloud identity abuse", "initial access"];
const SECTORS = ["healthcare", "government", "energy", "finance", "financial services", "telecommunications", "education", "manufacturing", "retail", "technology", "cloud services", "legal", "transportation", "insurance", "media", "defense", "critical infrastructure", "hospitality"];
