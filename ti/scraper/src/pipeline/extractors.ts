...
const MALWARE = ["emotet", "trickbot", "cobalt strike", "qakbot", "plugx", "sliver", "carbanak", "mimikatz", "icedid", "rclone", "anydesk", "snake", "powgoop", "wellmess"];
const TECHNIQUES = ["phishing", "credential dumping", "lateral movement", "command and control", "exfiltration", "persistence", "spearphishing", "data exfiltration", "sms phishing", "living off the land", "exploit", "intrusion"];
