...
check(apifyStoreReadinessInvariant.publishedBuildVersion === "0.6.3", "Apify published build version drifted");
check(apifyStoreReadinessInvariant.latestProofRunId === "dQzvWhNM2OHrBWVfo", "Apify proof run id drifted");
check(apifyStoreReadinessInvariant.latestProofDatasetId === "aP1dqnK7uEezn5jJv", "Apify proof dataset id drifted");
