...
export function routeChecks(): RouteCheck[] {
  return [
    ...
    { owner: "Agent 10", name: "product_slo", method: "GET", path: "/v1/ops/product-slo", expectKeys: ["schemaVersion", "dashboard", "metrics", "slos", "dailySnapshot", "measurementBoundary", "resourceGuardrails"] },
