...
const checks = [
  ...
  apifyStoreActor.publishedBuildVersion === "0.6.4",
  apifyStoreActor.outputContract === "safe_metadata_only.v1",
  stringArray(apifyStoreActor.categories).join(",") === "SECURITY,MONITORING",
  apifyLatestBuild.buildVersion === "0.6.4",
  apifyLatestProofRun.runId === "iMQGeezZ8bx7WtlhQ",
  apifyLatestProofRun.datasetId === "5PLmkE30luBA5Lbgc",
