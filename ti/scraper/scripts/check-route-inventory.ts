...
function routeChecks(): RouteCheck[] {
  return [
    ...
    { owner: "Agent 10", name: "product_slo", method: "GET", path: "/v1/ops/product-slo?proofMode=local&generatedAt=2026-06-20T12:00:00.000Z", expectKeys: ["schemaVersion", "dashboard", "metrics", "paidProductEconomics", "sourceMonetizationGate", "buyerVisibleQualityLiftGate", "marketplaceGraphSignals", "graphPivotLiftGate", "relationshipConfidenceGate", "paidGraphSearchPackGate", "hundredSellableRowGraphPivotPlan", "qualityConversionGate", "liveFreshnessQualityGate", "freshnessRepairLoop", "entitySpecificityLift", "falsePositiveSuppressionGate", "paidRowAudit100", "first100AdmissionQuality", "graphSellableSupportPacket", "graphPublicCorroborationPivotPacket", "paidReleaseTruthBoard", "slos", "apifyLaunchExperiment", "dailySnapshot", "deploymentProof", "resourceGuardrails"] },
