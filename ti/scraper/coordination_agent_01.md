...
- Aligned the paid Actor gate source-pack readout with Program DB local 300-row progress: `projectedRowsAfterParserAdmission=300`, `remainingSellableRowsAfterParserAdmission=0`, and source-pack projections still excluded from paid credit.
