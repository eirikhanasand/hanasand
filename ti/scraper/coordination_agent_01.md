...
- Latest verification for the policy patch: `bun test src/tests/planner.test.ts`, `bun test src/tests/darknetMetadata.test.ts`, `bun test src/tests/pipeline.test.ts`, `bun run check`, and full `bun test` pass.
