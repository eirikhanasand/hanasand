...
The standby case reader uses the read-only grants in `scripts/resilience/standby-permissions.sql`. Keep case writes, VM passwords and repository secrets out of that role.
