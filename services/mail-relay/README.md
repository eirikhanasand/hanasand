...
- Secrets now live in the in-project mail/mail-relay runtime directory, mode 0700; secret files remain mode 0600 and are ignored by Git. OVH SMTP storage is durable in data; never remove this directory or the existing unrelated mail service during redeployment.
