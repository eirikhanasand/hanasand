...
ROOT = Path('/home/ubuntu/hanasand-resilience/support')
...
def start(release):
    ...
    for key in ('RESILIENCE_STATE_FILE', 'RESILIENCE_ESSENTIAL_ONLY', 'AI_HEALTH_WORKER_BASE', 'SUPPORT_SERVICE_BASE'):
