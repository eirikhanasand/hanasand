...
The live `shared_buffers=8GB` and `listen_addresses=127.0.0.1` values are also persisted in the replica configuration, keeping it consistent with the container startup settings.
