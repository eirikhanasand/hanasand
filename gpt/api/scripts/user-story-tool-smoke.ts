...
async function main() {
    ...
    const cases: Scenario[] = [
        ...
        {
            id: 'immigration-careful-site',
            title: 'Immigration careful site',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#581-the-immigration-advisor-site-must-be-careful',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('immigration-careful-site'),
                appName: 'CarefulPath Advisory',
                productType: 'immigration advisory information site',
                productBrief: 'CarefulPath Advisory explains services, process, document preparation, timeline and fee caveats, contact paths, and legal-outcome disclaimers without collecting private case details.',
            }),
        },
        {
            id: 'case-prep-task-api',
            title: 'Case prep task API',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#582-case-prep-needs-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('case-prep-task-api'),
                appName: 'CasePrepTask API',
            }),
        },
        {
            id: 'document-prep-privacy-worker',
            title: 'Document prep privacy worker',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#583-document-prep-nudges-need-privacy',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('document-prep-privacy-worker'),
                appName: 'DocumentPrepPrivacy Worker',
            }),
        },
        {
            id: 'energy-auditor-credibility-site',
            title: 'Energy auditor credibility site',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#584-a-local-energy-auditor-needs-credibility',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('energy-auditor-credibility-site'),
                appName: 'EnvelopeCheck',
                productType: 'home energy audit services site',
                productBrief: 'EnvelopeCheck explains audit services, visit process, rebate caveats, prep checklist, sample report, and contact path without guaranteed savings or fake rebate forms.',
            }),
        },
        {
            id: 'audit-request-triage-api',
            title: 'Audit request triage API',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#585-audit-requests-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('audit-request-triage-api'),
                appName: 'AuditRequestTriage API',
            }),
        },
        {
            id: 'audit-prep-reminder-worker',
            title: 'Audit prep reminder worker',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#586-audit-prep-reminders-need-restraint',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('audit-prep-reminder-worker'),
                appName: 'AuditPrepReminder Worker',
            }),
        },
        {
            id: 'grant-writer-proof-site',
            title: 'Grant writer proof site',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#587-the-grant-writer-page-needs-proof-without-hype',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('grant-writer-proof-site'),
                appName: 'PlainGrant Studio',
                productType: 'grant writing services site',
                productBrief: 'PlainGrant Studio explains services, client fit, timeline, material checklist, reporting caveats, and contact paths without invented win rates or fake guarantees.',
            }),
        },
        {
            id: 'grant-pipeline-api',
            title: 'Grant pipeline API',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#588-grant-pipeline-needs-visibility',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('grant-pipeline-api'),
                appName: 'GrantPipeline API',
            }),
        },
        {
            id: 'grant-deadline-nudge-worker',
            title: 'Grant deadline nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#589-grant-deadline-nudges-cannot-be-noisy',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('grant-deadline-nudge-worker'),
                appName: 'GrantDeadlineNudge Worker',
            }),
        },
        {
            id: 'catering-qualifier-site',
            title: 'Catering qualifier site',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#590-the-catering-page-needs-to-qualify-events',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('catering-qualifier-site'),
                appName: 'TableScope Catering',
                productType: 'catering services qualification site',
                productBrief: 'TableScope Catering shows menu categories, event types, minimums, service area, timing caveats, allergy disclaimer, and inquiry path without fake checkout or live availability.',
            }),
        },
        {
            id: 'catering-lead-api',
            title: 'Catering lead API',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#591-catering-leads-need-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('catering-lead-api'),
                appName: 'CateringLead API',
            }),
        },
        {
            id: 'menu-followup-worker',
            title: 'Menu followup worker',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#592-menu-followups-need-boundaries',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('menu-followup-worker'),
                appName: 'MenuFollowup Worker',
            }),
        },
        {
            id: 'it-support-substance-site',
            title: 'IT support substance site',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#593-the-it-support-page-feels-like-vapor',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('it-support-substance-site'),
                appName: 'OpsDesk IT',
                productType: 'managed IT support services site',
                productBrief: 'OpsDesk IT explains services, response expectations, onboarding, security caveats, supported org profiles, and contact paths without fake SLA claims or ticket portal.',
            }),
        },
        {
            id: 'support-triage-api',
            title: 'Support triage API',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#594-support-requests-need-basic-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('support-triage-api'),
                appName: 'SupportTriage API',
            }),
        },
        {
            id: 'support-escalation-worker',
            title: 'Support escalation worker',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#595-support-escalations-need-control',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('support-escalation-worker'),
                appName: 'SupportEscalation Worker',
            }),
        },
        {
            id: 'estate-sale-calm-site',
            title: 'Estate sale calm site',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#596-the-estate-sale-page-needs-calm',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('estate-sale-calm-site'),
                appName: 'CalmSale',
                productType: 'estate sale information site',
                productBrief: 'CalmSale presents dates, location caveats, item categories, sale rules, accessibility, parking, and contact path without ecommerce, reservations, or fake cart.',
            }),
        },
        {
            id: 'sale-item-group-api',
            title: 'Sale item group API',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#597-sale-items-need-simple-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('sale-item-group-api'),
                appName: 'SaleItemGroup API',
            }),
        },
        {
            id: 'held-item-pickup-worker',
            title: 'Held item pickup worker',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#598-pickup-coordination-needs-guardrails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('held-item-pickup-worker'),
                appName: 'HeldItemPickup Worker',
            }),
        },
        {
            id: 'translation-specificity-site',
            title: 'Translation specificity site',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#599-the-translation-studio-page-needs-specificity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('translation-specificity-site'),
                appName: 'ExactPhrase Studio',
                productType: 'translation studio services site',
                productBrief: 'ExactPhrase Studio explains languages, domain specialties, process, turnaround caveats, certification caveats, file-prep checklist, and quote path without fake upload or instant translation.',
            }),
        },
        {
            id: 'translation-quote-api',
            title: 'Translation quote API',
            storyPath: 'agents/training-scenarios/user_stories/581-600-deadline-trust-user-stories.md#600-translation-quotes-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('translation-quote-api'),
                appName: 'TranslationQuote API',
            }),
        },
        {
            id: 'accessibility-consultant-site',
            title: 'Accessibility consultant site',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#601-the-accessibility-consultant-page-sounds-generic',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('accessibility-consultant-site'),
                appName: 'AccessPlain',
                productType: 'accessibility consulting services site',
                productBrief: 'AccessPlain explains audits, remediation help, training, deliverables, process, caveats, and contact paths without guaranteed compliance claims or fake badges.',
            }),
        },
        {
            id: 'accessibility-finding-api',
            title: 'Accessibility finding API',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#602-audit-findings-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('accessibility-finding-api'),
                appName: 'AccessibilityFinding API',
            }),
        },
        {
            id: 'remediation-nudge-worker',
            title: 'Remediation nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#603-remediation-nudges-need-proof',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('remediation-nudge-worker'),
                appName: 'RemediationNudge Worker',
            }),
        },
        {
            id: 'fire-safety-training-site',
            title: 'Fire safety training site',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#604-the-fire-safety-training-page-is-confusing',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('fire-safety-training-site'),
                appName: 'ClearExit Training',
                productType: 'fire safety training services site',
                productBrief: 'ClearExit Training explains training types, audience fit, delivery format, site requirements, certificate caveats, and quote paths in plain operational language.',
            }),
        },
        {
            id: 'safety-training-request-api',
            title: 'Safety training request API',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#605-training-requests-need-scheduling-fields',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('safety-training-request-api'),
                appName: 'SafetyTrainingRequest API',
            }),
        },
        {
            id: 'training-prep-reminder-worker',
            title: 'Training prep reminder worker',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#606-training-prep-reminders-need-limits',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('training-prep-reminder-worker'),
                appName: 'TrainingPrepReminder Worker',
            }),
        },
        {
            id: 'local-tour-practical-site',
            title: 'Local tour practical site',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#607-the-local-tour-page-needs-less-hype',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('local-tour-practical-site'),
                appName: 'WalkPlain Tours',
                productType: 'local walking tour information site',
                productBrief: 'WalkPlain Tours shows tour types, meeting point caveats, weather policy, accessibility notes, group sizes, price caveats, and inquiry path without fake booking.',
            }),
        },
        {
            id: 'tour-request-api',
            title: 'Tour request API',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#608-tour-requests-need-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('tour-request-api'),
                appName: 'TourRequest API',
            }),
        },
        {
            id: 'weather-followup-worker',
            title: 'Weather followup worker',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#609-weather-followups-need-caution',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('weather-followup-worker'),
                appName: 'WeatherFollowup Worker',
            }),
        },
        {
            id: 'debt-counselor-trust-site',
            title: 'Debt counselor trust site',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#610-the-debt-counselor-site-needs-trust',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('debt-counselor-trust-site'),
                appName: 'SteadyDebt Help',
                productType: 'debt counseling information site',
                productBrief: 'SteadyDebt Help explains services, document checklist, process, fee caveats, urgent help notes, and contact paths without collecting financial details or promising outcomes.',
            }),
        },
        {
            id: 'counseling-request-api',
            title: 'Counseling request API',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#611-counseling-requests-need-safe-intake',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('counseling-request-api'),
                appName: 'CounselingRequest API',
            }),
        },
        {
            id: 'quiet-counseling-followup-worker',
            title: 'Quiet counseling followup worker',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#612-counseling-followups-must-be-quiet',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('quiet-counseling-followup-worker'),
                appName: 'QuietCounselingFollowup Worker',
            }),
        },
        {
            id: 'equipment-rental-boundary-site',
            title: 'Equipment rental boundary site',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#613-the-equipment-rental-page-needs-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('equipment-rental-boundary-site'),
                appName: 'RentPlain Gear',
                productType: 'equipment rental information site',
                productBrief: 'RentPlain Gear explains categories, rental rules, deposit caveats, pickup instructions, safety notes, availability caveats, and inquiry paths without fake inventory or checkout.',
            }),
        },
        {
            id: 'rental-request-api',
            title: 'Rental request API',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#614-rental-requests-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('rental-request-api'),
                appName: 'RentalRequest API',
            }),
        },
        {
            id: 'rental-return-nudge-worker',
            title: 'Rental return nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#615-return-nudges-need-guardrails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('rental-return-nudge-worker'),
                appName: 'RentalReturnNudge Worker',
            }),
        },
        {
            id: 'music-teacher-clarity-site',
            title: 'Music teacher clarity site',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#616-the-music-teacher-page-needs-clarity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('music-teacher-clarity-site'),
                appName: 'PracticeRoom Lessons',
                productType: 'private music teacher lesson site',
                productBrief: 'PracticeRoom Lessons explains lesson types, levels, schedule caveats, practice expectations, pricing caveats, trial lesson path, and contact without fake booking or payment.',
            }),
        },
        {
            id: 'lesson-inquiry-api',
            title: 'Lesson inquiry API',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#617-lesson-inquiries-need-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('lesson-inquiry-api'),
                appName: 'LessonInquiry API',
            }),
        },
        {
            id: 'trial-lesson-nudge-worker',
            title: 'Trial lesson nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#618-trial-lesson-nudges-need-manners',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('trial-lesson-nudge-worker'),
                appName: 'TrialLessonNudge Worker',
            }),
        },
        {
            id: 'vendor-onboarding-info-site',
            title: 'Vendor onboarding info site',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#619-the-vendor-onboarding-page-needs-less-fluff',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('vendor-onboarding-info-site'),
                appName: 'VendorStart Desk',
                productType: 'vendor onboarding information site',
                productBrief: 'VendorStart Desk explains onboarding steps, required documents, security review, payment setup caveats, timeline, contacts, and dense procurement guidance without collecting bank data.',
            }),
        },
        {
            id: 'vendor-onboarding-task-api',
            title: 'Vendor onboarding task API',
            storyPath: 'agents/training-scenarios/user_stories/601-620-messy-operator-user-stories.md#620-vendor-onboarding-tasks-need-accountability',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('vendor-onboarding-task-api'),
                appName: 'VendorOnboardingTask API',
            }),
        },
        {
            id: 'lab-services-trust-site',
            title: 'Lab services trust site',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#621-the-lab-services-page-needs-trust',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('lab-services-trust-site'),
                appName: 'ChainLab Services',
                productType: 'testing lab services information site',
                productBrief: 'ChainLab Services explains service categories, sample preparation, turnaround caveats, chain of custody, pricing caveats, and contact paths without fake accreditation claims.',
            }),
        },
        {
            id: 'sample-intake-api',
            title: 'Sample intake API',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#622-sample-intake-needs-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('sample-intake-api'),
                appName: 'SampleIntake API',
            }),
        },
        {
            id: 'lab-status-nudge-worker',
            title: 'Lab status nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#623-lab-status-nudges-need-auditability',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('lab-status-nudge-worker'),
                appName: 'LabStatusNudge Worker',
            }),
        },
        {
            id: 'home-inspector-fit-site',
            title: 'Home inspector fit site',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#624-the-home-inspector-page-should-filter-fit',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('home-inspector-fit-site'),
                appName: 'ScopeHouse Inspection',
                productType: 'home inspection services site',
                productBrief: 'ScopeHouse Inspection explains services, inspection scope, limits, prep checklist, report timing caveats, sample report, and contact path without defect-detection guarantees.',
            }),
        },
        {
            id: 'inspection-request-api',
            title: 'Inspection request API',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#625-inspection-requests-need-reality',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('inspection-request-api'),
                appName: 'InspectionRequest API',
            }),
        },
        {
            id: 'inspection-prep-reminder-worker',
            title: 'Inspection prep reminder worker',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#626-inspection-prep-reminders-need-restraint',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('inspection-prep-reminder-worker'),
                appName: 'InspectionPrepReminder Worker',
            }),
        },
        {
            id: 'public-records-plain-site',
            title: 'Public records plain site',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#627-the-public-records-page-needs-plain-language',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('public-records-plain-site'),
                appName: 'OpenDesk Records',
                productType: 'public records information site',
                productBrief: 'OpenDesk Records explains request process, fee caveats, timelines, exemptions, contacts, documents, and accessibility in plain language without fake live filing.',
            }),
        },
        {
            id: 'records-request-api',
            title: 'Records request API',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#628-records-requests-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('records-request-api'),
                appName: 'RecordsRequest API',
            }),
        },
        {
            id: 'records-deadline-worker',
            title: 'Records deadline worker',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#629-records-deadline-nudges-need-caution',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('records-deadline-worker'),
                appName: 'RecordsDeadline Worker',
            }),
        },
        {
            id: 'elder-care-calm-site',
            title: 'Elder care calm site',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#630-the-elder-care-page-needs-calm',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('elder-care-calm-site'),
                appName: 'FamilyBridge Care',
                productType: 'elder care coordination information site',
                productBrief: 'FamilyBridge Care explains services, family process, visit notes, cost caveats, service boundaries, emergency disclaimers, and contact paths without collecting medical details.',
            }),
        },
        {
            id: 'care-inquiry-api',
            title: 'Care inquiry API',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#631-care-requests-need-safe-intake',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('care-inquiry-api'),
                appName: 'CareInquiry API',
            }),
        },
        {
            id: 'private-care-followup-worker',
            title: 'Private care followup worker',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#632-care-followups-must-be-private',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('private-care-followup-worker'),
                appName: 'PrivateCareFollowup Worker',
            }),
        },
        {
            id: 'incident-reporting-trust-site',
            title: 'Incident reporting trust site',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#633-incident-reporting-page-needs-trust',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('incident-reporting-trust-site'),
                appName: 'SafeReport Guide',
                productType: 'incident reporting information site',
                productBrief: 'SafeReport Guide explains reporting process, helpful info checklist, privacy notes, timeline caveats, contacts, and urgent escalation without blame language or fake submission.',
            }),
        },
        {
            id: 'incident-review-api',
            title: 'Incident review API',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#634-incident-reviews-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('incident-review-api'),
                appName: 'IncidentReview API',
            }),
        },
        {
            id: 'incident-action-reminder-worker',
            title: 'Incident action reminder worker',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#635-action-reminders-need-discipline',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('incident-action-reminder-worker'),
                appName: 'IncidentActionReminder Worker',
            }),
        },
        {
            id: 'executive-coach-specific-site',
            title: 'Executive coach specific site',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#636-the-executive-coach-page-needs-specificity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('executive-coach-specific-site'),
                appName: 'CadenceBoard Coaching',
                productType: 'executive coaching services site',
                productBrief: 'CadenceBoard Coaching explains offerings, audience fit, cadence, confidentiality, outcome caveats, pricing caveats, and contact path with restrained senior tone.',
            }),
        },
        {
            id: 'coaching-lead-api',
            title: 'Coaching lead API',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#637-coaching-leads-need-qualification',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('coaching-lead-api'),
                appName: 'CoachingLead API',
            }),
        },
        {
            id: 'coaching-followup-worker',
            title: 'Coaching followup worker',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#638-coaching-followups-need-taste',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('coaching-followup-worker'),
                appName: 'CoachingFollowup Worker',
            }),
        },
        {
            id: 'art-commission-boundary-site',
            title: 'Art commission boundary site',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#639-the-art-commission-page-needs-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('art-commission-boundary-site'),
                appName: 'StudioScope Commissions',
                productType: 'art commission information site',
                productBrief: 'StudioScope Commissions presents style placeholders, process, timeline caveats, usage rights notes, pricing caveats, availability caveats, and inquiry path without checkout.',
            }),
        },
        {
            id: 'commission-request-api',
            title: 'Commission request API',
            storyPath: 'agents/training-scenarios/user_stories/621-640-high-consequence-user-stories.md#640-commission-requests-need-structure',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('commission-request-api'),
                appName: 'CommissionRequest API',
            }),
        },
        {
            id: 'crisis-communications-calm-site',
            title: 'Crisis communications calm site',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#641-the-crisis-communications-page-needs-calm',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('crisis-communications-calm-site'),
                appName: 'CalmSignal Comms',
                productType: 'crisis communications services site',
                productBrief: 'CalmSignal Comms explains services, first-response process, response tiers, media prep, caveats, and contact paths without fear marketing or guaranteed reputation outcomes.',
            }),
        },
        {
            id: 'crisis-request-api',
            title: 'Crisis request API',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#642-crisis-requests-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('crisis-request-api'),
                appName: 'CrisisRequest API',
            }),
        },
        {
            id: 'crisis-followup-worker',
            title: 'Crisis followup worker',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#643-crisis-followups-need-control',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('crisis-followup-worker'),
                appName: 'CrisisFollowup Worker',
            }),
        },
        {
            id: 'shelter-calls-site',
            title: 'Shelter calls site',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#644-the-shelter-page-needs-to-reduce-calls',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('shelter-calls-site'),
                appName: 'HarborPaws Info',
                productType: 'animal shelter information site',
                productBrief: 'HarborPaws Info explains adoption process, foster information, visiting hours, fee caveats, preparation checklist, and contact path without fake applications or payments.',
            }),
        },
        {
            id: 'adoption-interest-api',
            title: 'Adoption interest API',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#645-adoption-interest-needs-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('adoption-interest-api'),
                appName: 'AdoptionInterest API',
            }),
        },
        {
            id: 'foster-followup-worker',
            title: 'Foster followup worker',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#646-foster-followups-need-boundaries',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('foster-followup-worker'),
                appName: 'FosterFollowup Worker',
            }),
        },
        {
            id: 'legal-aid-plain-site',
            title: 'Legal aid plain site',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#647-the-legal-aid-page-needs-plain-help',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('legal-aid-plain-site'),
                appName: 'PlainHelp Clinic',
                productType: 'legal aid clinic information site',
                productBrief: 'PlainHelp Clinic explains services, eligibility, document checklist, scope limits, urgent notes, clinic times, and contact path without legal advice or outcome promises.',
            }),
        },
        {
            id: 'clinic-slot-triage-api',
            title: 'Clinic slot triage API',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#648-clinic-slots-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('clinic-slot-triage-api'),
                appName: 'ClinicSlotTriage API',
            }),
        },
        {
            id: 'private-document-reminder-worker',
            title: 'Private document reminder worker',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#649-document-reminders-need-privacy',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('private-document-reminder-worker'),
                appName: 'PrivateDocumentReminder Worker',
            }),
        },
        {
            id: 'construction-safety-substance-site',
            title: 'Construction safety substance site',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#650-the-construction-safety-page-needs-substance',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('construction-safety-substance-site'),
                appName: 'SiteSafe Plain',
                productType: 'construction safety consulting site',
                productBrief: 'SiteSafe Plain explains services, toolbox talks, audits, incident review, site requirements, caveats, and contact path without fake certification claims.',
            }),
        },
        {
            id: 'toolbox-talk-api',
            title: 'Toolbox talk API',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#651-toolbox-talks-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('toolbox-talk-api'),
                appName: 'ToolboxTalk API',
            }),
        },
        {
            id: 'safety-talk-nudge-worker',
            title: 'Safety talk nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#652-safety-talk-nudges-need-discipline',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('safety-talk-nudge-worker'),
                appName: 'SafetyTalkNudge Worker',
            }),
        },
        {
            id: 'pest-control-calm-site',
            title: 'Pest control calm site',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#653-the-pest-control-page-needs-less-panic',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('pest-control-calm-site'),
                appName: 'CalmPest Services',
                productType: 'pest control services site',
                productBrief: 'CalmPest Services explains services, preparation steps, safety caveats, followup timing, pricing caveats, service area, and contact path without fear marketing or fake booking.',
            }),
        },
        {
            id: 'pest-service-request-api',
            title: 'Pest service request API',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#654-service-requests-need-routing',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('pest-service-request-api'),
                appName: 'PestServiceRequest API',
            }),
        },
        {
            id: 'prep-followup-worker',
            title: 'Prep followup worker',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#655-prep-followups-need-guardrails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('prep-followup-worker'),
                appName: 'PrepFollowup Worker',
            }),
        },
        {
            id: 'board-governance-clarity-site',
            title: 'Board governance clarity site',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#656-the-board-governance-page-needs-dense-clarity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('board-governance-clarity-site'),
                appName: 'BoardPlain Advisory',
                productType: 'board governance consulting site',
                productBrief: 'BoardPlain Advisory explains services, board pack support, policies, meeting cadence, confidentiality caveats, onboarding path, and executive tone without legal guarantees.',
            }),
        },
        {
            id: 'board-pack-api',
            title: 'Board pack API',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#657-board-packs-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('board-pack-api'),
                appName: 'BoardPack API',
            }),
        },
        {
            id: 'board-pack-nudge-worker',
            title: 'Board pack nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#658-board-pack-nudges-need-discretion',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('board-pack-nudge-worker'),
                appName: 'BoardPackNudge Worker',
            }),
        },
        {
            id: 'warranty-repair-trust-site',
            title: 'Warranty repair trust site',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#659-the-warranty-repair-page-needs-trust',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('warranty-repair-trust-site'),
                appName: 'WarrantyBench',
                productType: 'warranty repair information site',
                productBrief: 'WarrantyBench explains warranty rules, covered items, process, timing caveats, exclusions, and contact path without fake claim approval, submission, or payment flow.',
            }),
        },
        {
            id: 'warranty-claim-api',
            title: 'Warranty claim API',
            storyPath: 'agents/training-scenarios/user_stories/641-660-frontline-operations-user-stories.md#660-warranty-claims-need-basic-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('warranty-claim-api'),
                appName: 'WarrantyClaim API',
            }),
        },
        {
            id: 'export-consultant-precision-site',
            title: 'Export consultant precision site',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#661-the-export-consultant-page-needs-precision',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('export-consultant-precision-site'),
                appName: 'ExportPlain Docs',
                productType: 'export documentation consulting site',
                productBrief: 'ExportPlain Docs explains services, document categories, process, timeline caveats, compliance caveats, and contact paths without legal guarantees or fake customs advice.',
            }),
        },
        {
            id: 'export-document-set-api',
            title: 'Export document set API',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#662-export-docs-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('export-document-set-api'),
                appName: 'ExportDocumentSet API',
            }),
        },
        {
            id: 'export-review-nudge-worker',
            title: 'Export review nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#663-export-review-nudges-need-audit-trail',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('export-review-nudge-worker'),
                appName: 'ExportReviewNudge Worker',
            }),
        },
        {
            id: 'facilities-reduce-tickets-site',
            title: 'Facilities reduce tickets site',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#664-the-facilities-page-needs-to-reduce-tickets',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('facilities-reduce-tickets-site'),
                appName: 'FacilityPlain Help',
                productType: 'facilities help information site',
                productBrief: 'FacilityPlain Help explains request categories, priorities, tenant checklist, response caveats, emergency notes, and contacts without fake live ticket submission.',
            }),
        },
        {
            id: 'facilities-request-api',
            title: 'Facilities request API',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#665-facilities-requests-need-routing',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('facilities-request-api'),
                appName: 'FacilitiesRequest API',
            }),
        },
        {
            id: 'vendor-dispatch-nudge-worker',
            title: 'Vendor dispatch nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#666-vendor-dispatch-nudges-need-limits',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('vendor-dispatch-nudge-worker'),
                appName: 'VendorDispatchNudge Worker',
            }),
        },
        {
            id: 'tutoring-center-clarity-site',
            title: 'Tutoring center clarity site',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#667-the-tutoring-center-page-needs-clarity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('tutoring-center-clarity-site'),
                appName: 'LevelPath Tutoring',
                productType: 'tutoring center information site',
                productBrief: 'LevelPath Tutoring explains subjects, levels, schedule caveats, assessment process, pricing caveats, parent information, and contact path without grade guarantees or fake booking.',
            }),
        },
        {
            id: 'tutoring-inquiry-api',
            title: 'Tutoring inquiry API',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#668-tutoring-inquiries-need-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('tutoring-inquiry-api'),
                appName: 'TutoringInquiry API',
            }),
        },
        {
            id: 'assessment-followup-worker',
            title: 'Assessment followup worker',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#669-assessment-followups-need-manners',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('assessment-followup-worker'),
                appName: 'AssessmentFollowup Worker',
            }),
        },
        {
            id: 'claim-helper-boundaries-site',
            title: 'Claim helper boundaries site',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#670-the-insurance-claim-helper-page-needs-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('claim-helper-boundaries-site'),
                appName: 'ClaimPlain Help',
                productType: 'claim documentation helper site',
                productBrief: 'ClaimPlain Help explains services, boundaries, document checklist, timeline caveats, and contact path without collecting claim details or promising payout outcomes.',
            }),
        },
        {
            id: 'claim-document-pack-api',
            title: 'Claim document pack API',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#671-claim-docs-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('claim-document-pack-api'),
                appName: 'ClaimDocumentPack API',
            }),
        },
        {
            id: 'claim-doc-nudge-worker',
            title: 'Claim doc nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#672-claim-doc-nudges-need-privacy',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('claim-doc-nudge-worker'),
                appName: 'ClaimDocNudge Worker',
            }),
        },
        {
            id: 'cemetery-info-sensitive-site',
            title: 'Cemetery info sensitive site',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#673-the-cemetery-info-page-needs-sensitivity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('cemetery-info-sensitive-site'),
                appName: 'QuietGrounds',
                productType: 'cemetery information site',
                productBrief: 'QuietGrounds explains plot information, rules, visiting hours, fee caveats, maintenance notes, records contact, accessibility, and visitor information without plot sales.',
            }),
        },
        {
            id: 'plot-record-api',
            title: 'Plot record API',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#674-plot-records-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('plot-record-api'),
                appName: 'PlotRecord API',
            }),
        },
        {
            id: 'maintenance-review-nudge-worker',
            title: 'Maintenance review nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#675-maintenance-review-nudges-need-care',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('maintenance-review-nudge-worker'),
                appName: 'MaintenanceReviewNudge Worker',
            }),
        },
        {
            id: 'policy-team-substance-site',
            title: 'Policy team substance site',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#676-the-policy-team-page-needs-substance',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('policy-team-substance-site'),
                appName: 'CivicBrief Lab',
                productType: 'policy research team information site',
                productBrief: 'CivicBrief Lab explains research areas, brief types, process, review caveats, stakeholder notes, and contact path with restrained civic tone, not campaign language.',
            }),
        },
        {
            id: 'policy-brief-api',
            title: 'Policy brief API',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#677-policy-briefs-need-workflow',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('policy-brief-api'),
                appName: 'PolicyBrief API',
            }),
        },
        {
            id: 'brief-review-nudge-worker',
            title: 'Brief review nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#678-brief-review-nudges-need-discipline',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('brief-review-nudge-worker'),
                appName: 'BriefReviewNudge Worker',
            }),
        },
        {
            id: 'photographer-qualifier-site',
            title: 'Photographer qualifier site',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#679-the-photographer-page-needs-to-qualify-clients',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('photographer-qualifier-site'),
                appName: 'FrameScope Studio',
                productType: 'commercial photographer qualification site',
                productBrief: 'FrameScope Studio explains service types, usage rights notes, prep checklist, timeline caveats, pricing caveats, availability caveat, and inquiry path without fake booking.',
            }),
        },
        {
            id: 'shoot-request-api',
            title: 'Shoot request API',
            storyPath: 'agents/training-scenarios/user_stories/661-680-admin-glue-user-stories.md#680-shoot-requests-need-structure',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('shoot-request-api'),
                appName: 'ShootRequest API',
            }),
        },
        {
            id: 'fleet-maintenance-guesswork-site',
            title: 'Fleet maintenance guesswork site',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#681-the-fleet-maintenance-page-needs-less-guesswork',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('fleet-maintenance-guesswork-site'),
                appName: 'FleetPlain Service',
                productType: 'fleet maintenance information site',
                productBrief: 'FleetPlain Service explains services, vehicle types, inspection cadence, downtime caveats, driver prep checklist, and contact path without fake booking or uptime guarantees.',
            }),
        },
        {
            id: 'fleet-work-order-api',
            title: 'Fleet work order API',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#682-fleet-work-orders-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('fleet-work-order-api'),
                appName: 'FleetWorkOrder API',
            }),
        },
        {
            id: 'downtime-nudge-worker',
            title: 'Downtime nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#683-downtime-nudges-need-restraint',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('downtime-nudge-worker'),
                appName: 'DowntimeNudge Worker',
            }),
        },
        {
            id: 'grant-reporting-discipline-site',
            title: 'Grant reporting discipline site',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#684-the-grant-reporting-page-needs-discipline',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('grant-reporting-discipline-site'),
                appName: 'ReportGrant Ops',
                productType: 'grant reporting services site',
                productBrief: 'ReportGrant Ops explains reporting support, data checklist, timeline caveats, funder format notes, review process, and contact path without compliance guarantees.',
            }),
        },
        {
            id: 'grant-report-api',
            title: 'Grant report API',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#685-grant-reports-need-workflow',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('grant-report-api'),
                appName: 'GrantReport API',
            }),
        },
        {
            id: 'report-review-nudge-worker',
            title: 'Report review nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#686-report-review-nudges-need-proof',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('report-review-nudge-worker'),
                appName: 'ReportReviewNudge Worker',
            }),
        },
        {
            id: 'billing-help-boundaries-site',
            title: 'Billing help boundaries site',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#687-the-billing-help-page-needs-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('billing-help-boundaries-site'),
                appName: 'BillReview Plain',
                productType: 'medical billing help information site',
                productBrief: 'BillReview Plain explains services, review scope, boundaries, document checklist, privacy note, and contact path without medical advice or patient-detail collection.',
            }),
        },
        {
            id: 'billing-review-request-api',
            title: 'Billing review request API',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#688-billing-review-requests-need-safe-intake',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('billing-review-request-api'),
                appName: 'BillingReviewRequest API',
            }),
        },
        {
            id: 'billing-followup-privacy-worker',
            title: 'Billing followup privacy worker',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#689-billing-followups-need-privacy',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('billing-followup-privacy-worker'),
                appName: 'BillingFollowupPrivacy Worker',
            }),
        },
        {
            id: 'archive-digitization-specifics-site',
            title: 'Archive digitization specifics site',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#690-the-archive-digitization-page-needs-specifics',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('archive-digitization-specifics-site'),
                appName: 'ArchivePlain Digitizing',
                productType: 'archive digitization services site',
                productBrief: 'ArchivePlain Digitizing explains services, media types, handling process, metadata caveats, turnaround caveats, and quote path without fake upload or preservation guarantees.',
            }),
        },
        {
            id: 'digitization-job-api',
            title: 'Digitization job API',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#691-digitization-jobs-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('digitization-job-api'),
                appName: 'DigitizationJob API',
            }),
        },
        {
            id: 'metadata-review-nudge-worker',
            title: 'Metadata review nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#692-metadata-review-nudges-need-care',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('metadata-review-nudge-worker'),
                appName: 'MetadataReviewNudge Worker',
            }),
        },
        {
            id: 'permit-help-plain-site',
            title: 'Permit help plain site',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#693-the-permit-help-page-needs-plain-steps',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('permit-help-plain-site'),
                appName: 'PermitPlain Help',
                productType: 'local permit help information site',
                productBrief: 'PermitPlain Help explains services, permit types, applicant checklist, timeline caveats, scope boundaries, and contact path without approval promises or fake filing.',
            }),
        },
        {
            id: 'permit-task-api',
            title: 'Permit task API',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#694-permit-tasks-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('permit-task-api'),
                appName: 'PermitTask API',
            }),
        },
        {
            id: 'permit-review-nudge-worker',
            title: 'Permit review nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#695-permit-review-nudges-need-boundaries',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('permit-review-nudge-worker'),
                appName: 'PermitReviewNudge Worker',
            }),
        },
        {
            id: 'food-pantry-practical-site',
            title: 'Food pantry practical site',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#696-the-food-pantry-page-needs-practicality',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('food-pantry-practical-site'),
                appName: 'PantryPlain',
                productType: 'food pantry information site',
                productBrief: 'PantryPlain explains hours, eligibility, preparation checklist, donation rules, volunteer path, accessibility notes, and contact without fake appointment booking or donation checkout.',
            }),
        },
        {
            id: 'pantry-interest-api',
            title: 'Pantry interest API',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#697-pantry-interest-needs-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('pantry-interest-api'),
                appName: 'PantryInterest API',
            }),
        },
        {
            id: 'pantry-followup-dignity-worker',
            title: 'Pantry followup dignity worker',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#698-pantry-followups-need-dignity',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('pantry-followup-dignity-worker'),
                appName: 'PantryFollowupDignity Worker',
            }),
        },
        {
            id: 'studio-rental-qualifier-site',
            title: 'Studio rental qualifier site',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#699-the-studio-rental-page-needs-qualification',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('studio-rental-qualifier-site'),
                appName: 'StudioPlain Rentals',
                productType: 'shared studio rental information site',
                productBrief: 'StudioPlain Rentals explains spaces, allowed uses, rules, insurance caveats, timing caveats, pricing caveats, and inquiry path without fake booking or payment.',
            }),
        },
        {
            id: 'studio-request-api',
            title: 'Studio request API',
            storyPath: 'agents/training-scenarios/user_stories/681-700-service-desk-user-stories.md#700-studio-requests-need-structure',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('studio-request-api'),
                appName: 'StudioRequest API',
            }),
        },
        {
            id: 'event-sponsorship-credible-site',
            title: 'Event sponsorship credible site',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#701-the-event-sponsorship-page-is-too-vague',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('event-sponsorship-credible-site'),
                appName: 'SponsorPlain',
                productType: 'event sponsorship information site',
                productBrief: 'SponsorPlain explains sponsor tiers, audience summary, sponsor benefits, asset and deadline notes, credibility copy, and contact path without fake checkout or invented sponsor logos.',
            }),
        },
        {
            id: 'sponsor-lead-api',
            title: 'Sponsor lead API',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#702-sponsor-leads-need-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('sponsor-lead-api'),
                appName: 'SponsorLead API',
            }),
        },
        {
            id: 'sponsor-followup-restraint-worker',
            title: 'Sponsor followup restraint worker',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#703-sponsor-followups-cannot-be-pushy',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('sponsor-followup-restraint-worker'),
                appName: 'SponsorFollowupRestraint Worker',
            }),
        },
        {
            id: 'hr-onboarding-boundaries-site',
            title: 'HR onboarding boundaries site',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#704-the-hr-onboarding-page-needs-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('hr-onboarding-boundaries-site'),
                appName: 'OnboardPlain',
                productType: 'HR onboarding support information site',
                productBrief: 'OnboardPlain explains onboarding scope, employee checklist, timeline caveats, privacy note, HR responsibility boundaries, and contact path without collecting employee personal details.',
            }),
        },
        {
            id: 'hr-onboarding-status-api',
            title: 'Onboarding task API',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#705-onboarding-tasks-need-status',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('hr-onboarding-status-api'),
                appName: 'OnboardingTask API',
            }),
        },
        {
            id: 'onboarding-consent-nudge-worker',
            title: 'Onboarding consent nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#706-onboarding-nudges-need-consent',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('onboarding-consent-nudge-worker'),
                appName: 'OnboardingConsentNudge Worker',
            }),
        },
        {
            id: 'b2b-demo-qualification-site',
            title: 'B2B demo qualification site',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#707-the-b2b-demo-page-needs-qualification',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('b2b-demo-qualification-site'),
                appName: 'DemoPlain SaaS',
                productType: 'B2B demo request information site',
                productBrief: 'DemoPlain SaaS explains target customer, problem list, prerequisites, pricing caveat, and call inquiry path without fake scheduling or exaggerated enterprise claims.',
            }),
        },
        {
            id: 'demo-request-api',
            title: 'Demo request API',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#708-demo-requests-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('demo-request-api'),
                appName: 'DemoRequest API',
            }),
        },
        {
            id: 'demo-reminder-restraint-worker',
            title: 'Demo reminder restraint worker',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#709-demo-reminder-worker-needs-restraint',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('demo-reminder-restraint-worker'),
                appName: 'DemoReminderRestraint Worker',
            }),
        },
        {
            id: 'security-review-boundaries-site',
            title: 'Security review boundaries site',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#710-the-security-review-page-must-not-overpromise',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('security-review-boundaries-site'),
                appName: 'SecureReview Plain',
                productType: 'vendor security review help site',
                productBrief: 'SecureReview Plain explains evidence checklist, review scope, timeline caveats, certification boundaries, and contact path without claiming compliance approval or adding a fake upload portal.',
            }),
        },
        {
            id: 'security-evidence-api',
            title: 'Security evidence API',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#711-security-evidence-needs-workflow',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('security-evidence-api'),
                appName: 'SecurityEvidence API',
            }),
        },
        {
            id: 'evidence-review-guardrail-worker',
            title: 'Evidence review guardrail worker',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#712-evidence-review-nudges-need-guardrails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('evidence-review-guardrail-worker'),
                appName: 'EvidenceReviewGuardrail Worker',
            }),
        },
        {
            id: 'product-recall-clarity-site',
            title: 'Product recall clarity site',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#713-the-product-recall-page-needs-clarity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('product-recall-clarity-site'),
                appName: 'RecallPlain',
                productType: 'product recall information site',
                productBrief: 'RecallPlain explains affected batch guidance, customer steps, refund caveats, support hours, and contact path without legal promises or sensitive customer data collection.',
            }),
        },
        {
            id: 'recall-case-api',
            title: 'Recall case API',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#714-recall-cases-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('recall-case-api'),
                appName: 'RecallCase API',
            }),
        },
        {
            id: 'recall-update-proof-worker',
            title: 'Recall update proof worker',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#715-recall-update-worker-needs-proof',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('recall-update-proof-worker'),
                appName: 'RecallUpdateProof Worker',
            }),
        },
        {
            id: 'artist-commission-taste-site',
            title: 'Artist commission taste site',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#716-the-artist-commission-page-needs-taste',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('artist-commission-taste-site'),
                appName: 'CommissionPlain',
                productType: 'artist commission information site',
                productBrief: 'CommissionPlain explains styles, process, boundaries, timeline caveats, pricing caveat, and inquiry path without ecommerce or generic agency copy.',
            }),
        },
        {
            id: 'artist-commission-request-api',
            title: 'Commission request API',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#717-commission-requests-need-structure',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('artist-commission-request-api'),
                appName: 'CommissionRequest API',
            }),
        },
        {
            id: 'commission-followup-soft-worker',
            title: 'Commission followup soft worker',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#718-commission-followups-need-softness',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('commission-followup-soft-worker'),
                appName: 'CommissionFollowupSoft Worker',
            }),
        },
        {
            id: 'internal-tool-intake-plain-site',
            title: 'Internal tool intake plain site',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#719-the-internal-tool-intake-page-needs-less-jargon',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('internal-tool-intake-plain-site'),
                appName: 'ToolRequest Plain',
                productType: 'internal tool intake information site',
                productBrief: 'ToolRequest Plain explains request checklist, examples, timeline caveats, unsuitable request boundaries, and contact path using nontechnical language without fake ticket submission.',
            }),
        },
        {
            id: 'internal-tool-request-api',
            title: 'Internal tool request API',
            storyPath: 'agents/training-scenarios/user_stories/701-720-commercial-handoff-user-stories.md#720-internal-tool-requests-need-prioritization',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('internal-tool-request-api'),
                appName: 'InternalToolRequest API',
            }),
        },
        {
            id: 'clinic-waitlist-honesty-site',
            title: 'Clinic waitlist honesty site',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#721-the-clinic-waitlist-page-needs-honesty',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('clinic-waitlist-honesty-site'),
                appName: 'WaitlistPlain Clinic',
                productType: 'clinic waitlist information site',
                productBrief: 'WaitlistPlain Clinic explains audience, update process, timing caveats, privacy boundaries, and contact path without patient details, medical advice, or fake booking.',
            }),
        },
        {
            id: 'clinic-waitlist-entry-api',
            title: 'Clinic waitlist entry API',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#722-clinic-waitlist-entries-need-safe-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('clinic-waitlist-entry-api'),
                appName: 'ClinicWaitlistEntry API',
            }),
        },
        {
            id: 'waitlist-privacy-nudge-worker',
            title: 'Waitlist privacy nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#723-waitlist-nudges-need-privacy',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('waitlist-privacy-nudge-worker'),
                appName: 'WaitlistPrivacyNudge Worker',
            }),
        },
        {
            id: 'volunteer-drive-practical-site',
            title: 'Volunteer drive practical site',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#724-the-volunteer-drive-page-is-too-cheerful',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('volunteer-drive-practical-site'),
                appName: 'VolunteerPlain Drive',
                productType: 'volunteer drive information site',
                productBrief: 'VolunteerPlain Drive explains roles, time commitment, training notes, boundaries, accessibility notes, and contact path without fake signup or inflated impact claims.',
            }),
        },
        {
            id: 'volunteer-interest-sort-api',
            title: 'Volunteer interest sort API',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#725-volunteer-interest-needs-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('volunteer-interest-sort-api'),
                appName: 'VolunteerInterestSort API',
            }),
        },
        {
            id: 'volunteer-followup-dignity-worker',
            title: 'Volunteer followup dignity worker',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#726-volunteer-followups-need-dignity',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('volunteer-followup-dignity-worker'),
                appName: 'VolunteerFollowupDignity Worker',
            }),
        },
        {
            id: 'legal-intake-warning-site',
            title: 'Legal intake warning site',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#727-the-legal-intake-page-needs-big-warnings',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('legal-intake-warning-site'),
                appName: 'IntakePlain Legal',
                productType: 'legal clinic intake information site',
                productBrief: 'IntakePlain Legal explains review scope, prohibited submissions, timing caveats, conflict caveats, and contact path without legal advice, uploads, or sensitive case-detail collection.',
            }),
        },
        {
            id: 'legal-intake-triage-api',
            title: 'Legal intake triage API',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#728-legal-intake-requests-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('legal-intake-triage-api'),
                appName: 'LegalIntakeTriage API',
            }),
        },
        {
            id: 'conflict-check-restraint-worker',
            title: 'Conflict check restraint worker',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#729-conflict-check-nudges-need-restraint',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('conflict-check-restraint-worker'),
                appName: 'ConflictCheckRestraint Worker',
            }),
        },
        {
            id: 'insurance-help-narrow-site',
            title: 'Insurance help narrow site',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#730-the-insurance-help-page-must-stay-narrow',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('insurance-help-narrow-site'),
                appName: 'ClaimPlain Help',
                productType: 'insurance claims help information site',
                productBrief: 'ClaimPlain Help explains claim explanation scope, document checklist, decision boundaries, timeline caveats, and contact path without coverage promises or fake claim submission.',
            }),
        },
        {
            id: 'claims-review-status-api',
            title: 'Claims review status API',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#731-claims-review-requests-need-status',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('claims-review-status-api'),
                appName: 'ClaimsReviewStatus API',
            }),
        },
        {
            id: 'claims-followup-proof-worker',
            title: 'Claims followup proof worker',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#732-claims-followups-need-proof',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('claims-followup-proof-worker'),
                appName: 'ClaimsFollowupProof Worker',
            }),
        },
        {
            id: 'repair-request-no-portal-site',
            title: 'Repair request no portal site',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#733-the-repair-request-page-needs-no-portal',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('repair-request-no-portal-site'),
                appName: 'RepairPlain',
                productType: 'property repair request information site',
                productBrief: 'RepairPlain explains tenant preparation checklist, emergency caveat, photo guidance, response-time caveat, and contact path without fake login or emergency promises.',
            }),
        },
        {
            id: 'repair-request-routing-api',
            title: 'Repair request routing API',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#734-repair-requests-need-routing',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('repair-request-routing-api'),
                appName: 'RepairRequestRouting API',
            }),
        },
        {
            id: 'repair-dispatch-guardrail-worker',
            title: 'Repair dispatch guardrail worker',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#735-repair-dispatch-nudges-need-guardrails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('repair-dispatch-guardrail-worker'),
                appName: 'RepairDispatchGuardrail Worker',
            }),
        },
        {
            id: 'launch-checklist-practical-site',
            title: 'Launch checklist practical site',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#736-the-launch-checklist-page-needs-less-startup-theater',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('launch-checklist-practical-site'),
                appName: 'LaunchPlain',
                productType: 'launch checklist information site',
                productBrief: 'LaunchPlain explains preparation checklist, risk notes, owner guidance, timing caveats, deferrable items, and contact path without startup hype or fake account creation.',
            }),
        },
        {
            id: 'launch-task-priority-api',
            title: 'Launch task priority API',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#737-launch-tasks-need-priorities',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('launch-task-priority-api'),
                appName: 'LaunchTaskPriority API',
            }),
        },
        {
            id: 'launch-nudge-focus-worker',
            title: 'Launch nudge focus worker',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#738-launch-nudges-need-focus',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('launch-nudge-focus-worker'),
                appName: 'LaunchNudgeFocus Worker',
            }),
        },
        {
            id: 'agency-handoff-specifics-site',
            title: 'Agency handoff specifics site',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#739-the-agency-handoff-page-needs-specifics',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('agency-handoff-specifics-site'),
                appName: 'HandoffPlain Agency',
                productType: 'agency handoff information site',
                productBrief: 'HandoffPlain Agency explains deliverables, limitations, maintenance notes, launch checklist, and support path without fake dashboard or generic agency marketing.',
            }),
        },
        {
            id: 'handoff-request-audit-api',
            title: 'Handoff request audit API',
            storyPath: 'agents/training-scenarios/user_stories/721-740-messy-revenue-support-user-stories.md#740-handoff-requests-need-audit-trail',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('handoff-request-audit-api'),
                appName: 'HandoffRequestAudit API',
            }),
        },
        {
            id: 'audit-prep-calm-site',
            title: 'Audit prep calm site',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#741-the-audit-prep-page-needs-less-panic',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('audit-prep-calm-site'),
                appName: 'AuditPlain Prep',
                productType: 'audit preparation information site',
                productBrief: 'AuditPlain Prep explains evidence checklist, owner guidance, timing caveats, prohibited upload guidance, and contact path without fake upload, certification promises, or alarmist language.',
            }),
        },
        {
            id: 'audit-evidence-status-api',
            title: 'Audit evidence status API',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#742-audit-evidence-requests-need-status',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('audit-evidence-status-api'),
                appName: 'AuditEvidenceStatus API',
            }),
        },
        {
            id: 'audit-nudge-proof-worker',
            title: 'Audit nudge proof worker',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#743-audit-nudges-need-proof',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('audit-nudge-proof-worker'),
                appName: 'AuditNudgeProof Worker',
            }),
        },
        {
            id: 'procurement-help-practical-site',
            title: 'Procurement help practical site',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#744-the-procurement-page-is-too-corporate',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('procurement-help-practical-site'),
                appName: 'ProcurePlain',
                productType: 'procurement help information site',
                productBrief: 'ProcurePlain explains target audience, document checklist, timeline caveats, buyer responsibility boundaries, and contact path without fake vendor portal or procurement outcome promises.',
            }),
        },
        {
            id: 'vendor-request-triage-api',
            title: 'Vendor request triage API',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#745-vendor-requests-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('vendor-request-triage-api'),
                appName: 'VendorRequestTriage API',
            }),
        },
        {
            id: 'procurement-followup-guardrail-worker',
            title: 'Procurement followup guardrail worker',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#746-procurement-followups-need-guardrails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('procurement-followup-guardrail-worker'),
                appName: 'ProcurementFollowupGuardrail Worker',
            }),
        },
        {
            id: 'incident-update-calm-site',
            title: 'Incident update calm site',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#747-the-incident-update-page-needs-calm',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('incident-update-calm-site'),
                appName: 'IncidentPlain',
                productType: 'incident update information site',
                productBrief: 'IncidentPlain explains current status, affected areas, user guidance, update cadence, and contact path without blame, fake live status, or uptime guarantees.',
            }),
        },
        {
            id: 'incident-update-tracking-api',
            title: 'Incident update tracking API',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#748-incident-updates-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('incident-update-tracking-api'),
                appName: 'IncidentUpdateTracking API',
            }),
        },
        {
            id: 'incident-reminder-restraint-worker',
            title: 'Incident reminder restraint worker',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#749-incident-reminder-worker-needs-restraint',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('incident-reminder-restraint-worker'),
                appName: 'IncidentReminderRestraint Worker',
            }),
        },
        {
            id: 'training-policy-plain-site',
            title: 'Training policy plain site',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#750-the-training-policy-page-needs-plain-english',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('training-policy-plain-site'),
                appName: 'TrainingPlain Policy',
                productType: 'training policy information site',
                productBrief: 'TrainingPlain Policy explains audience, required actions, deadline caveats, exception process, manager duties, and contact path without fake LMS or jargon.',
            }),
        },
        {
            id: 'training-completion-api',
            title: 'Training completion API',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#751-training-completion-needs-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('training-completion-api'),
                appName: 'TrainingCompletion API',
            }),
        },
        {
            id: 'training-manager-nudge-worker',
            title: 'Training manager nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#752-training-nudges-need-manager-context',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('training-manager-nudge-worker'),
                appName: 'TrainingManagerNudge Worker',
            }),
        },
        {
            id: 'access-request-boundaries-site',
            title: 'Access request boundaries site',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#753-the-access-request-page-needs-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('access-request-boundaries-site'),
                appName: 'AccessPlain',
                productType: 'access request information site',
                productBrief: 'AccessPlain explains request checklist, approval guidance, timing caveats, prohibited password guidance, and contact path without fake request submission or secret collection.',
            }),
        },
        {
            id: 'access-request-workflow-api',
            title: 'Access request workflow API',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#754-access-requests-need-safe-workflow',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('access-request-workflow-api'),
                appName: 'AccessRequestWorkflow API',
            }),
        },
        {
            id: 'access-review-safeguard-worker',
            title: 'Access review safeguard worker',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#755-access-review-nudges-need-safeguards',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('access-review-safeguard-worker'),
                appName: 'AccessReviewSafeguard Worker',
            }),
        },
        {
            id: 'customer-migration-reassurance-site',
            title: 'Customer migration reassurance site',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#756-the-customer-migration-page-needs-reassurance',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('customer-migration-reassurance-site'),
                appName: 'MigrationPlain',
                productType: 'customer migration information site',
                productBrief: 'MigrationPlain explains change summary, preparation checklist, timing caveats, risk notes, and support path without fake login, account dashboard, or guarantees.',
            }),
        },
        {
            id: 'migration-task-ownership-api',
            title: 'Migration task ownership API',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#757-migration-tasks-need-ownership',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('migration-task-ownership-api'),
                appName: 'MigrationTaskOwnership API',
            }),
        },
        {
            id: 'migration-nudge-focus-worker',
            title: 'Migration nudge focus worker',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#758-migration-nudges-need-focus',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('migration-nudge-focus-worker'),
                appName: 'MigrationNudgeFocus Worker',
            }),
        },
        {
            id: 'refund-policy-clear-site',
            title: 'Refund policy clear site',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#759-the-refund-policy-page-needs-less-drama',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('refund-policy-clear-site'),
                appName: 'RefundPlain',
                productType: 'refund policy information site',
                productBrief: 'RefundPlain explains eligibility, timeline caveats, exceptions, customer preparation checklist, and support path without fake order lookup, checkout, or legal overpromises.',
            }),
        },
        {
            id: 'refund-request-audit-api',
            title: 'Refund request audit API',
            storyPath: 'agents/training-scenarios/user_stories/741-760-messy-compliance-ops-user-stories.md#760-refund-requests-need-audit-trail',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('refund-request-audit-api'),
                appName: 'RefundRequestAudit API',
            }),
        },
        {
            id: 'data-deletion-trust-site',
            title: 'Data deletion trust site',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#761-the-data-deletion-page-needs-trust',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('data-deletion-trust-site'),
                appName: 'DeletionPlain',
                productType: 'data deletion request information site',
                productBrief: 'DeletionPlain explains deletion scope, request checklist, timing caveats, exception notes, and contact path without fake login, identity-document upload, or unprovable privacy guarantees.',
            }),
        },
        {
            id: 'deletion-request-safe-api',
            title: 'Deletion request safe API',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#762-deletion-requests-need-safe-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('deletion-request-safe-api'),
                appName: 'DeletionRequestSafe API',
            }),
        },
        {
            id: 'deletion-followup-minimal-worker',
            title: 'Deletion followup minimal worker',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#763-deletion-followups-need-no-details',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('deletion-followup-minimal-worker'),
                appName: 'DeletionFollowupMinimal Worker',
            }),
        },
        {
            id: 'warranty-conditions-site',
            title: 'Warranty conditions site',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#764-the-warranty-page-needs-real-conditions',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('warranty-conditions-site'),
                appName: 'WarrantyPlain',
                productType: 'warranty information site',
                productBrief: 'WarrantyPlain explains coverage, exclusions, proof checklist, timing caveats, and support path without fake claim submission, legal overpromises, or invented guarantee language.',
            }),
        },
        {
            id: 'warranty-request-triage-api',
            title: 'Warranty request triage API',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#765-warranty-requests-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('warranty-request-triage-api'),
                appName: 'WarrantyRequestTriage API',
            }),
        },
        {
            id: 'warranty-proof-nudge-worker',
            title: 'Warranty proof nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#766-warranty-nudges-need-restraint',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('warranty-proof-nudge-worker'),
                appName: 'WarrantyProofNudge Worker',
            }),
        },
        {
            id: 'field-visit-logistics-site',
            title: 'Field visit logistics site',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#767-the-field-visit-page-needs-logistics',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('field-visit-logistics-site'),
                appName: 'VisitPlain Field',
                productType: 'field visit information site',
                productBrief: 'VisitPlain Field explains site-prep checklist, access requirements, safety notes, timing caveats, and contact path without fake booking or safety guarantees.',
            }),
        },
        {
            id: 'field-visit-routing-api',
            title: 'Field visit routing API',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#768-field-visits-need-routing',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('field-visit-routing-api'),
                appName: 'FieldVisitRouting API',
            }),
        },
        {
            id: 'field-visit-reminder-guardrail-worker',
            title: 'Field visit reminder guardrail worker',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#769-field-visit-reminders-need-guardrails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('field-visit-reminder-guardrail-worker'),
                appName: 'FieldVisitReminderGuardrail Worker',
            }),
        },
        {
            id: 'beta-feedback-focused-site',
            title: 'Beta feedback focused site',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#770-the-beta-feedback-page-needs-less-noise',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('beta-feedback-focused-site'),
                appName: 'FeedbackPlain Beta',
                productType: 'beta feedback information site',
                productBrief: 'FeedbackPlain Beta explains useful feedback guidance, out-of-scope guidance, timeline caveats, privacy note, and contact path without fake voting board or account creation.',
            }),
        },
        {
            id: 'beta-feedback-sort-api',
            title: 'Beta feedback sort API',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#771-beta-feedback-needs-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('beta-feedback-sort-api'),
                appName: 'BetaFeedbackSort API',
            }),
        },
        {
            id: 'feedback-review-focus-worker',
            title: 'Feedback review focus worker',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#772-feedback-review-nudges-need-focus',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('feedback-review-focus-worker'),
                appName: 'FeedbackReviewFocus Worker',
            }),
        },
        {
            id: 'supplier-delay-candor-site',
            title: 'Supplier delay candor site',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#773-the-supplier-delay-page-needs-candor',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('supplier-delay-candor-site'),
                appName: 'DelayPlain',
                productType: 'supplier delay update information site',
                productBrief: 'DelayPlain explains delayed item categories, plain reason summary, customer guidance, timing caveats, and support path without blame, fake live tracking, or delivery guarantees.',
            }),
        },
        {
            id: 'supplier-delay-tracking-api',
            title: 'Supplier delay tracking API',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#774-supplier-delays-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('supplier-delay-tracking-api'),
                appName: 'SupplierDelayTracking API',
            }),
        },
        {
            id: 'delay-update-proof-worker',
            title: 'Delay update proof worker',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#775-delay-update-worker-needs-proof',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('delay-update-proof-worker'),
                appName: 'DelayUpdateProof Worker',
            }),
        },
        {
            id: 'partner-onboarding-boundaries-site',
            title: 'Partner onboarding boundaries site',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#776-the-partner-onboarding-page-needs-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('partner-onboarding-boundaries-site'),
                appName: 'PartnerPlain',
                productType: 'partner onboarding information site',
                productBrief: 'PartnerPlain explains onboarding steps, document checklist, timing caveats, partner responsibility boundaries, and support path without fake contract upload or partnership guarantees.',
            }),
        },
        {
            id: 'partner-onboarding-status-api',
            title: 'Partner onboarding status API',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#777-partner-onboarding-needs-status',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('partner-onboarding-status-api'),
                appName: 'PartnerOnboardingStatus API',
            }),
        },
        {
            id: 'partner-followup-timing-worker',
            title: 'Partner followup timing worker',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#778-partner-followups-need-timing',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('partner-followup-timing-worker'),
                appName: 'PartnerFollowupTiming Worker',
            }),
        },
        {
            id: 'renewal-reminder-fair-site',
            title: 'Renewal reminder fair site',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#779-the-renewal-reminder-page-needs-fairness',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('renewal-reminder-fair-site'),
                appName: 'RenewalPlain',
                productType: 'renewal information site',
                productBrief: 'RenewalPlain explains renewal scope, timing caveats, cancellation path, support path, and fair-language boundaries without fake billing portal, payment flow, or dark-pattern copy.',
            }),
        },
        {
            id: 'renewal-review-tracking-api',
            title: 'Renewal review tracking API',
            storyPath: 'agents/training-scenarios/user_stories/761-780-customer-trust-field-ops-user-stories.md#780-renewal-reviews-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('renewal-review-tracking-api'),
                appName: 'RenewalReviewTracking API',
            }),
        },
        {
            id: 'retainer-boundary-site',
            title: 'Retainer boundary site',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#781-the-retainer-page-needs-plain-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('retainer-boundary-site'),
                appName: 'RetainerPlain',
                productType: 'design retainer information site',
                productBrief: 'RetainerPlain explains included services, exclusions, response-time caveats, handoff notes, and contact path without fake payment, fake client dashboard, or vague agency hype.',
            }),
        },
        {
            id: 'retainer-request-scope-api',
            title: 'Retainer request scope API',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#782-retainer-requests-need-scope',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('retainer-request-scope-api'),
                appName: 'RetainerRequestScope API',
            }),
        },
        {
            id: 'retainer-followup-timing-worker',
            title: 'Retainer followup timing worker',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#783-retainer-followups-need-timing',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('retainer-followup-timing-worker'),
                appName: 'RetainerFollowupTiming Worker',
            }),
        },
        {
            id: 'budget-review-boundary-site',
            title: 'Budget review boundary site',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#784-the-budget-review-page-must-not-pretend',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('budget-review-boundary-site'),
                appName: 'BudgetPlain Review',
                productType: 'budget review information site',
                productBrief: 'BudgetPlain Review explains review scope, document checklist, decision boundaries, timing caveats, and contact path without financial advice, fake upload, or guaranteed savings.',
            }),
        },
        {
            id: 'budget-review-safe-api',
            title: 'Budget review safe API',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#785-budget-review-requests-need-safe-intake',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('budget-review-safe-api'),
                appName: 'BudgetReviewSafe API',
            }),
        },
        {
            id: 'budget-followup-privacy-worker',
            title: 'Budget followup privacy worker',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#786-budget-followups-need-privacy',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('budget-followup-privacy-worker'),
                appName: 'BudgetFollowupPrivacy Worker',
            }),
        },
        {
            id: 'workshop-prep-site',
            title: 'Workshop prep site',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#787-the-workshop-page-needs-real-prep',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('workshop-prep-site'),
                appName: 'WorkshopPlain',
                productType: 'community workshop information site',
                productBrief: 'WorkshopPlain explains audience, prerequisites, what-to-bring checklist, schedule caveat, accessibility notes, and contact path without fake ticketing or overpromising outcomes.',
            }),
        },
        {
            id: 'workshop-interest-sort-api',
            title: 'Workshop interest sort API',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#788-workshop-interest-needs-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('workshop-interest-sort-api'),
                appName: 'WorkshopInterestSort API',
            }),
        },
        {
            id: 'workshop-followup-care-worker',
            title: 'Workshop followup care worker',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#789-workshop-followups-need-care',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('workshop-followup-care-worker'),
                appName: 'WorkshopFollowupCare Worker',
            }),
        },
        {
            id: 'catering-constraint-site',
            title: 'Catering constraint site',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#790-the-catering-page-needs-constraints',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('catering-constraint-site'),
                appName: 'CateringPlain',
                productType: 'catering information site',
                productBrief: 'CateringPlain explains menu categories, dietary caveat, lead-time notes, service area, and quote path without fake ordering, payment, or allergy guarantees.',
            }),
        },
        {
            id: 'catering-request-detail-api',
            title: 'Catering request detail API',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#791-catering-requests-need-details',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('catering-request-detail-api'),
                appName: 'CateringRequestDetail API',
            }),
        },
        {
            id: 'catering-quote-restraint-worker',
            title: 'Catering quote restraint worker',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#792-catering-quote-nudges-need-restraint',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('catering-quote-restraint-worker'),
                appName: 'CateringQuoteRestraint Worker',
            }),
        },
        {
            id: 'grant-workshop-specific-site',
            title: 'Grant workshop specific site',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#793-the-grant-workshop-page-needs-specifics',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('grant-workshop-specific-site'),
                appName: 'GrantWorkshop Plain',
                productType: 'grant workshop information site',
                productBrief: 'GrantWorkshop Plain explains audience, topics covered, preparation checklist, timeline caveat, and contact path without fake registration or funding-success promises.',
            }),
        },
        {
            id: 'grant-workshop-lead-api',
            title: 'Grant workshop lead API',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#794-grant-workshop-leads-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('grant-workshop-lead-api'),
                appName: 'GrantWorkshopLead API',
            }),
        },
        {
            id: 'grant-workshop-followup-proof-worker',
            title: 'Grant workshop followup proof worker',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#795-grant-workshop-followups-need-proof',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('grant-workshop-followup-proof-worker'),
                appName: 'GrantWorkshopFollowupProof Worker',
            }),
        },
        {
            id: 'cleaning-practical-site',
            title: 'Cleaning practical site',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#796-the-cleaning-service-page-needs-practicality',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('cleaning-practical-site'),
                appName: 'CleaningPlain',
                productType: 'cleaning service information site',
                productBrief: 'CleaningPlain explains services, prep checklist, access note, timing caveats, and quote path without fake booking, payment, or safety guarantees.',
            }),
        },
        {
            id: 'cleaning-request-routing-api',
            title: 'Cleaning request routing API',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#797-cleaning-requests-need-routing',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('cleaning-request-routing-api'),
                appName: 'CleaningRequestRouting API',
            }),
        },
        {
            id: 'cleaning-reminder-guardrail-worker',
            title: 'Cleaning reminder guardrail worker',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#798-cleaning-reminder-worker-needs-guardrails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('cleaning-reminder-guardrail-worker'),
                appName: 'CleaningReminderGuardrail Worker',
            }),
        },
        {
            id: 'photo-proofing-simple-site',
            title: 'Photo proofing simple site',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#799-the-photo-proofing-page-needs-simplicity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('photo-proofing-simple-site'),
                appName: 'ProofingPlain',
                productType: 'photo proofing information site',
                productBrief: 'ProofingPlain explains review process, feedback guidance, timeline caveat, usage caveat, and contact path without fake gallery, login, or licensing guarantees.',
            }),
        },
        {
            id: 'proofing-request-status-api',
            title: 'Proofing request status API',
            storyPath: 'agents/training-scenarios/user_stories/781-800-agency-finance-local-ops-user-stories.md#800-proofing-requests-need-status',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('proofing-request-status-api'),
                appName: 'ProofingRequestStatus API',
            }),
        },
    ]
