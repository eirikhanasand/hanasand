...
async function main() {
    ...
    const cases: Scenario[] = [
        ...
        {
            id: 'architect-portfolio-site',
            title: 'Architect portfolio site',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#521-the-architect-portfolio-feels-like-a-template',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('architect-portfolio-site'),
                appName: 'LineWeight Studio',
                productType: 'architecture portfolio site',
                productBrief: 'LineWeight Studio presents selected architecture projects, metadata, process, press, awards, and contact with restrained editorial typography and no sales-funnel clutter.',
            }),
        },
        {
            id: 'architecture-inquiry-api',
            title: 'Architecture inquiry API',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#522-project-inquiries-are-buried-in-email',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('architecture-inquiry-api'),
                appName: 'ArchitectureInquiry API',
            }),
        },
        {
            id: 'inquiry-followup-worker',
            title: 'Inquiry followup worker',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#523-inquiry-followups-need-taste',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('inquiry-followup-worker'),
                appName: 'InquiryFollowup Worker',
            }),
        },
        {
            id: 'nonprofit-trust-site',
            title: 'Nonprofit trust site',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#524-the-nonprofit-page-is-too-vague',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('nonprofit-trust-site'),
                appName: 'ClearHarbor Fund',
                productType: 'nonprofit trust and programs site',
                productBrief: 'ClearHarbor Fund explains programs, governance, board, reports, volunteer paths, donation caveats, and impact narrative without invented statistics or fake payment flow.',
            }),
        },
        {
            id: 'donor-pledge-api',
            title: 'Donor pledge API',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#525-donor-pledges-need-audit-trail',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('donor-pledge-api'),
                appName: 'DonorPledge API',
            }),
        },
        {
            id: 'receipt-control-worker',
            title: 'Receipt control worker',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#526-receipts-must-be-controlled',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('receipt-control-worker'),
                appName: 'ReceiptControl Worker',
            }),
        },
        {
            id: 'clinic-info-site',
            title: 'Clinic information site',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#527-the-clinic-needs-a-calm-information-page',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('clinic-info-site'),
                appName: 'NorthDesk Clinic',
                productType: 'clinic information site',
                productBrief: 'NorthDesk Clinic provides services, hours, insurance caveats, prep instructions, accessibility, contact, and urgent-care disclaimers without collecting health data.',
            }),
        },
        {
            id: 'appointment-request-api',
            title: 'Appointment request API',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#528-appointment-requests-need-triage',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('appointment-request-api'),
                appName: 'AppointmentRequest API',
            }),
        },
        {
            id: 'clinic-request-nudge-worker',
            title: 'Clinic reminder worker',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#529-clinic-reminders-need-safety-rails',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('clinic-request-nudge-worker'),
                appName: 'ClinicReminder Worker',
            }),
        },
        {
            id: 'manufacturing-capability-site',
            title: 'Manufacturing capability site',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#530-a-manufacturer-needs-a-serious-capability-page',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('manufacturing-capability-site'),
                appName: 'ToleranceWorks',
                productType: 'manufacturing capability site',
                productBrief: 'ToleranceWorks shows materials, tolerances, industries, quality documents, lead-time caveats, and quote paths in a procurement-friendly technical tone.',
            }),
        },
        {
            id: 'rfq-structure-api',
            title: 'RFQ structure API',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#531-rfqs-need-structure',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('rfq-structure-api'),
                appName: 'RfqStructure API',
            }),
        },
        {
            id: 'rfq-followup-worker',
            title: 'RFQ followup worker',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#532-rfq-followups-should-respect-engineering',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('rfq-followup-worker'),
                appName: 'RfqFollowup Worker',
            }),
        },
        {
            id: 'wedding-florist-site',
            title: 'Wedding florist site',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#533-the-wedding-vendor-site-feels-fake',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('wedding-florist-site'),
                appName: 'StemSeason',
                productType: 'wedding florist site',
                productBrief: 'StemSeason presents wedding floral packages, seasonal availability, gallery placeholders, planning process, budget caveats, and inquiry paths without fake cart or calendar.',
            }),
        },
        {
            id: 'wedding-inquiry-api',
            title: 'Wedding inquiry API',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#534-wedding-inquiries-need-priorities',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('wedding-inquiry-api'),
                appName: 'WeddingInquiry API',
            }),
        },
        {
            id: 'seasonal-followup-worker',
            title: 'Seasonal followup worker',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#535-seasonal-followups-need-boundaries',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('seasonal-followup-worker'),
                appName: 'SeasonalFollowup Worker',
            }),
        },
        {
            id: 'municipal-roadworks-site',
            title: 'Municipal roadworks site',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#536-a-municipality-microsite-needs-clarity',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('municipal-roadworks-site'),
                appName: 'RoadPlain',
                productType: 'municipal roadworks microsite',
                productBrief: 'RoadPlain explains roadwork timeline, affected streets, access, parking, updates, contacts, documents, and caveats in plain language without fake live maps.',
            }),
        },
        {
            id: 'roadwork-update-api',
            title: 'Roadwork update API',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#537-roadwork-updates-need-an-api',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('roadwork-update-api'),
                appName: 'RoadworkUpdate API',
            }),
        },
        {
            id: 'resident-alert-worker',
            title: 'Resident alert worker',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#538-resident-alerts-must-be-careful',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('resident-alert-worker'),
                appName: 'ResidentAlert Worker',
            }),
        },
        {
            id: 'vendor-procurement-site',
            title: 'Vendor procurement site',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#539-the-internal-tool-vendor-page-needs-procurement-trust',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('vendor-procurement-site'),
                appName: 'ProcurePilot',
                productType: 'enterprise vendor procurement site',
                productBrief: 'ProcurePilot presents security posture, deployment options, support, pricing caveats, procurement documents, and pilot paths with restrained enterprise tone.',
            }),
        },
        {
            id: 'pilot-request-api',
            title: 'Pilot request API',
            storyPath: 'agents/training-scenarios/user_stories/521-540-ambiguous-production-user-stories.md#540-pilot-requests-need-accountability',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('pilot-request-api'),
                appName: 'PilotRequest API',
            }),
        },
        {
            id: 'accountant-deadline-site',
            title: 'Accountant deadline site',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#541-the-accountant-site-sounds-like-everyone-else',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('accountant-deadline-site'),
                appName: 'LedgerPlain',
                productType: 'accountant services and deadline site',
                productBrief: 'LedgerPlain explains accounting services, filing deadlines, client document checklists, pricing caveats, contact paths, and trust cues without personalized tax advice.',
            }),
        },
        {
            id: 'client-document-request-api',
            title: 'Client document request API',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#542-client-documents-are-chaos',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('client-document-request-api'),
                appName: 'ClientDocumentRequest API',
            }),
        },
        {
            id: 'document-chaser-worker',
            title: 'Document chaser worker',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#543-document-chasers-must-not-annoy-clients',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('document-chaser-worker'),
                appName: 'DocumentChaser Worker',
            }),
        },
        {
            id: 'renovation-fit-site',
            title: 'Renovation fit site',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#544-a-renovation-contractor-needs-fewer-bad-leads',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('renovation-fit-site'),
                appName: 'FitBuild Renovations',
                productType: 'renovation contractor lead-fit site',
                productBrief: 'FitBuild Renovations filters homeowners with services, project types, process, budget ranges, timeline caveats, quote path, and portfolio-safe placeholders without fake instant quotes.',
            }),
        },
        {
            id: 'estimate-reality-api',
            title: 'Estimate reality API',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#545-estimate-requests-need-reality-checks',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('estimate-reality-api'),
                appName: 'EstimateReality API',
            }),
        },
        {
            id: 'permit-milestone-worker',
            title: 'Permit milestone worker',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#546-permit-milestones-get-forgotten',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('permit-milestone-worker'),
                appName: 'PermitMilestone Worker',
            }),
        },
        {
            id: 'course-no-scam-site',
            title: 'Course no-scam site',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#547-the-course-page-should-not-feel-like-a-scam',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('course-no-scam-site'),
                appName: 'SteadyCourse',
                productType: 'credible course application page',
                productBrief: 'SteadyCourse explains outcomes, audience fit, syllabus, schedule, prerequisites, refund caveats, application path, and instructor context without fake urgency or income claims.',
            }),
        },
        {
            id: 'cohort-application-api',
            title: 'Cohort application API',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#548-cohort-applications-need-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('cohort-application-api'),
                appName: 'CohortApplication API',
            }),
        },
        {
            id: 'cohort-followup-worker',
            title: 'Cohort followup worker',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#549-cohort-followups-should-be-fair',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('cohort-followup-worker'),
                appName: 'CohortFollowup Worker',
            }),
        },
        {
            id: 'mediation-neutral-site',
            title: 'Mediation neutral site',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#550-a-mediation-practice-needs-neutral-copy',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('mediation-neutral-site'),
                appName: 'NeutralTable Mediation',
                productType: 'mediation practice information site',
                productBrief: 'NeutralTable Mediation explains service areas, process, neutrality, fee caveats, preparation checklist, contact, and legal-advice disclaimer without outcome promises.',
            }),
        },
        {
            id: 'mediation-intake-api',
            title: 'Mediation intake API',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#551-mediation-intake-needs-boundaries',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('mediation-intake-api'),
                appName: 'MediationIntake API',
            }),
        },
        {
            id: 'conflict-check-worker',
            title: 'Conflict check worker',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#552-conflict-check-followups-need-discipline',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('conflict-check-worker'),
                appName: 'ConflictCheck Worker',
            }),
        },
        {
            id: 'private-events-site',
            title: 'Private events site',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#553-the-restaurant-private-events-page-is-useless',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('private-events-site'),
                appName: 'RoomService Events',
                productType: 'restaurant private events site',
                productBrief: 'RoomService Events shows rooms, capacity, menus, minimum spend caveats, timing, accessibility, gallery placeholders, and inquiry path without fake reservation checkout.',
            }),
        },
        {
            id: 'event-inquiry-api',
            title: 'Event inquiry API',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#554-event-inquiries-need-less-back-and-forth',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('event-inquiry-api'),
                appName: 'EventInquiry API',
            }),
        },
        {
            id: 'deposit-reminder-worker',
            title: 'Deposit reminder worker',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#555-deposit-reminders-need-caution',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('deposit-reminder-worker'),
                appName: 'DepositReminder Worker',
            }),
        },
        {
            id: 'privacy-substance-site',
            title: 'Privacy substance site',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#556-the-privacy-consultant-page-needs-substance',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('privacy-substance-site'),
                appName: 'PlainPrivacy Advisory',
                productType: 'privacy consulting services site',
                productBrief: 'PlainPrivacy Advisory explains audits, DPIA support, vendor reviews, training, deliverables, caveats, and contact paths without fake compliance guarantees.',
            }),
        },
        {
            id: 'vendor-risk-review-api',
            title: 'Vendor risk review API',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#557-vendor-risk-reviews-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('vendor-risk-review-api'),
                appName: 'VendorRiskReview API',
            }),
        },
        {
            id: 'risk-review-nudge-worker',
            title: 'Risk review nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#558-risk-review-nudges-should-be-boring',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('risk-review-nudge-worker'),
                appName: 'RiskReviewNudge Worker',
            }),
        },
        {
            id: 'student-housing-info-site',
            title: 'Student housing info site',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#559-student-housing-info-is-scattered',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('student-housing-info-site'),
                appName: 'CampusNest',
                productType: 'student housing information site',
                productBrief: 'CampusNest organizes buildings, eligibility, rent caveats, move-in steps, maintenance paths, contacts, documents, and accessibility notes without fake applications or payments.',
            }),
        },
        {
            id: 'maintenance-request-api',
            title: 'Maintenance request API',
            storyPath: 'agents/training-scenarios/user_stories/541-560-pressure-tested-user-stories.md#560-maintenance-requests-need-a-basic-api',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('maintenance-request-api'),
                appName: 'MaintenanceRequest API',
            }),
        },
        {
            id: 'museum-exhibit-context-site',
            title: 'Museum exhibit context site',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#561-the-museum-exhibit-page-needs-context',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('museum-exhibit-context-site'),
                appName: 'ObjectRoom',
                productType: 'museum exhibit information site',
                productBrief: 'ObjectRoom presents exhibit objects, dates, accessibility, visitor notes, related programs, sponsors, and contact paths with dignified editorial tone and no fake ticket checkout.',
            }),
        },
        {
            id: 'object-loan-api',
            title: 'Object loan API',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#562-object-loans-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('object-loan-api'),
                appName: 'ObjectLoan API',
            }),
        },
        {
            id: 'loan-deadline-worker',
            title: 'Loan deadline worker',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#563-loan-deadline-nudges-need-care',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('loan-deadline-worker'),
                appName: 'LoanDeadline Worker',
            }),
        },
        {
            id: 'repair-shop-calls-site',
            title: 'Repair shop calls site',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#564-a-repair-shop-needs-fewer-phone-calls',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('repair-shop-calls-site'),
                appName: 'SpokeBench',
                productType: 'bicycle repair shop information site',
                productBrief: 'SpokeBench answers repair service questions with services, turnaround caveats, what to bring, pricing caveats, location, contact, and inquiry path without fake real-time booking.',
            }),
        },
        {
            id: 'shop-repair-ticket-api',
            title: 'Repair ticket API',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#565-repair-tickets-need-basic-structure',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('shop-repair-ticket-api'),
                appName: 'RepairTicket API',
            }),
        },
        {
            id: 'repair-pickup-worker',
            title: 'Repair pickup worker',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#566-pickup-reminders-need-a-guard',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('repair-pickup-worker'),
                appName: 'RepairPickup Worker',
            }),
        },
        {
            id: 'therapy-boundaries-site',
            title: 'Therapy boundaries site',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#567-the-therapy-practice-site-needs-boundaries',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('therapy-boundaries-site'),
                appName: 'QuietHarbor Therapy',
                productType: 'therapy practice information site',
                productBrief: 'QuietHarbor Therapy explains service areas, fit, fees caveat, availability note, crisis disclaimer, and contact path without collecting health details or promising outcomes.',
            }),
        },
        {
            id: 'consult-request-api',
            title: 'Consult request API',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#568-consult-requests-need-minimal-intake',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('consult-request-api'),
                appName: 'ConsultRequest API',
            }),
        },
        {
            id: 'private-consult-nudge-worker',
            title: 'Private consult nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#569-consult-nudges-must-be-private',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('private-consult-nudge-worker'),
                appName: 'PrivateConsultNudge Worker',
            }),
        },
        {
            id: 'resident-info-site',
            title: 'Resident info site',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#570-a-property-manager-needs-a-resident-page',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('resident-info-site'),
                appName: 'ResidentPlain',
                productType: 'property resident information site',
                productBrief: 'ResidentPlain explains move-in steps, rent caveats, maintenance paths, rules, contacts, documents, accessibility, and emergency notes without fake tenant portal payments.',
            }),
        },
        {
            id: 'lease-task-api',
            title: 'Lease task API',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#571-lease-tasks-need-tracking',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('lease-task-api'),
                appName: 'LeaseTask API',
            }),
        },
        {
            id: 'lease-task-nudge-worker',
            title: 'Lease task nudge worker',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#572-lease-task-nudges-need-discipline',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('lease-task-nudge-worker'),
                appName: 'LeaseTaskNudge Worker',
            }),
        },
        {
            id: 'procurement-training-site',
            title: 'Procurement training site',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#573-the-procurement-training-page-is-too-abstract',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('procurement-training-site'),
                appName: 'ProcurePractice',
                productType: 'procurement training services site',
                productBrief: 'ProcurePractice presents procurement training modules, outcomes, formats, prerequisites, pricing caveats, pilot path, and facilitator context without fake certifications or checkout.',
            }),
        },
        {
            id: 'training-cohort-api',
            title: 'Training cohort API',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#574-training-cohorts-need-coordination',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('training-cohort-api'),
                appName: 'TrainingCohort API',
            }),
        },
        {
            id: 'cohort-prep-worker',
            title: 'Cohort prep worker',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#575-cohort-prep-reminders-need-limits',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('cohort-prep-worker'),
                appName: 'CohortPrep Worker',
            }),
        },
        {
            id: 'youth-program-trust-site',
            title: 'Youth program trust site',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#576-the-youth-program-site-needs-trust',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('youth-program-trust-site'),
                appName: 'SafeSteps Program',
                productType: 'youth program parent information site',
                productBrief: 'SafeSteps Program explains schedule, eligibility, safety, staff, cost caveats, transport notes, contact paths, and parent trust cues without collecting child data.',
            }),
        },
        {
            id: 'program-interest-api',
            title: 'Program interest API',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#577-program-interest-needs-sorting',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('program-interest-api'),
                appName: 'ProgramInterest API',
            }),
        },
        {
            id: 'guardian-followup-worker',
            title: 'Guardian followup worker',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#578-guardian-followups-need-safety',
            kind: 'redis',
            tool: 'scaffoldFastifyWorkerRedisApp',
            maxElapsedMs: 6 * 1000,
            run: () => scaffoldFastifyWorkerRedisApp({
                targetDir: rel('guardian-followup-worker'),
                appName: 'GuardianFollowup Worker',
            }),
        },
        {
            id: 'fractional-cfo-site',
            title: 'Fractional CFO site',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#579-a-fractional-cfo-needs-a-better-services-page',
            kind: 'next',
            tool: 'scaffoldNextjsDockerApp',
            maxElapsedMs: 50 * 1000,
            run: () => scaffoldNextjsDockerApp({
                targetDir: rel('fractional-cfo-site'),
                appName: 'SoberLedger CFO',
                productType: 'fractional CFO services site',
                productBrief: 'SoberLedger CFO presents service packages, audience fit, deliverables, cadence, pricing caveats, onboarding path, and serious B2B tone without investment advice or outcome promises.',
            }),
        },
        {
            id: 'cfo-lead-api',
            title: 'CFO lead API',
            storyPath: 'agents/training-scenarios/user_stories/561-580-operator-ambiguity-user-stories.md#580-cfo-leads-need-qualification',
            kind: 'postgres',
            tool: 'scaffoldFastifyPostgresApp',
            maxElapsedMs: 5 * 1000,
            run: () => scaffoldFastifyPostgresApp({
                targetDir: rel('cfo-lead-api'),
                appName: 'CfoLead API',
            }),
        },
    ]
